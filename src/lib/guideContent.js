...
The path is not simple — Belgian bureaucracy is famously layered, and the process involves both federal immigration authorities and regional employment agencies (VDAB in Flanders, FOREM in Wallonia, Actiris in Brussels). But for Nigerians with a strong degree or in-demand skill, Belgium is a genuine destination — especially if EU residency is your long-term goal.`,
    ...
    summary: {
      undergrad: {
        intro: "Belgian universities charge non-EU students €4,000–9,800/year — significantly less than the UK or USA. Most undergraduate programmes are in Dutch or French. English-taught undergrad options exist at VUB, KU Leuven (selected programmes), and University of Antwerp. You apply directly to the university, receive an acceptance letter, then apply for a Belgian long-stay student visa (Type D) at the Belgian Embassy in Abuja.",
        firstSteps: [
        ...
        keyFacts: [
          "Tuition: €4,000–9,800/year for non-EU students — far less than UK or US fees",
          "Students can work up to 20 hrs/week during term; full-time July–September",
          "Most undergrad is in Dutch or French — English-taught options are limited",
          "After graduation: apply for 12-month job-search permit to stay and find work",
          "Commune registration within 8 days of arrival is mandatory by law",
        ],
        outcome: "A Belgian undergraduate degree gives you an EU-recognized qualification from a top European university system and access to the 12-month post-graduation job-search permit. If you find work, you transition to the Belgian Single Permit route toward permanent residency after 5 years.",
      },
      masters: {
        intro: "Belgium is one of Europe's best-kept secrets for Master's students. Most postgraduate programmes at KU Leuven, Ghent University, and VUB are in English. Fees are €4,500–12,000/year. The VLIR-UOS scholarship is a fully funded Belgian government scholarship specifically for Nigerians — it covers tuition, flights, living allowance (~€860/month), and health insurance. Apply in September–January for the following September intake.",
        firstSteps: [
          { action: "Check the VLIR-UOS eligible programmes list at vliruos.be from September", detail: "The VLIR-UOS scholarship covers only specific listed Master's programmes. Study the list in September. You can apply to up to 3 programmes simultaneously. This is one of the best-funded scholarships available to Nigerians anywhere in Europe." },
          { action: "Apply for VLIR-UOS scholarship via vlir.be — window closes late January/February", detail: "Required: transcripts, CV, motivation letter (specific to each programme), 2 reference letters, English proficiency proof (IELTS 6.5+). Apply to your top 3 eligible programmes at once." },
          { action: "Simultaneously apply directly to universities as backup", detail: "Apply directly to KU Leuven, Ghent, VUB, and other universities in parallel. Some have rolling admissions. This ensures admission even if VLIR-UOS is unsuccessful." },
          { action: "Once admitted: apply for Type D student visa at Belgian Embassy Abuja", detail: "Documents: passport, acceptance letter, scholarship letter (or proof of funds €700–900/month), accommodation proof, insurance, passport photos. Fee: ~€180. Processing: 4–8 weeks." },
        ],
        keyFacts: [
          "VLIR-UOS: full tuition + ~€860/month + return flights + health insurance — apply September–January",
          "KU Leuven and Ghent are consistently top-100 in Europe — degrees recognized across the EU",
          "Most Belgian Master's: 60 ECTS (1 year) or 120 ECTS (2 years)",
          "After graduation: 12-month job-search permit before transitioning to Single Permit worker status",
          "Register at Commune within 8 days of arrival — mandatory",
        ],
        outcome: "Belgian Master's → 12-month job-search permit → Single Permit (employer-sponsored) → Permanent Residency after 5 years. VLIR-UOS recipients complete a fully funded EU Master's degree with zero personal cost — one of the best-value educational paths for Nigerian students.",
      },
      phd: {
        intro: "PhD students in Belgium are typically employed on a full academic staff contract — you receive a salary (~€2,000–2,500/month net), not just a stipend, with full Belgian social security coverage including healthcare, unemployment insurance, and pension. You are an employee. The VLIR-UOS ICP PhD programme, FWO (Flanders), and FNRS (French-speaking) are the main external funding bodies.",
        firstSteps: [
          { action: "Search for funded PhD positions on academictransfer.com, FWO.be, and university job boards", detail: "KU Leuven jobs: kuleuven.be/personeel/jobsite. Ghent University: ugent.be/en/work. FWO fellowships: fwo.be. VLIR-UOS ICP PhD: vlir.be. Email professors directly if you have a strong research match." },
          { action: "Receive employment contract or scholarship letter — then your university initiates Single Permit", detail: "For employee-contract PhDs: your university (as employer) submits a Single Permit application to VDAB/FOREM/Actiris. You don't file this yourself. They receive the Annexe 46 authorisation." },
          { action: "Apply for Type D visa at Belgian Embassy Abuja using your Annexe 46", detail: "Bring: passport, Annexe 46, employment contract, accommodation proof, passport photos. Fee: ~€180. Processing: 3–6 weeks. This step happens after the Single Permit is approved in Belgium." },
          { action: "Arrive and register at Commune within 8 days", detail: "Receive temporary Bijlage 15, then your A-card (1-year residence permit, renewable annually). Mark your renewal date 3 months early — your university renews the permit each year tied to your contract." },
        ],
        keyFacts: [
          "Belgian PhD students on employment contracts earn ~€2,000–2,500/month net — not a stipend, a salary",
          "Full social security: healthcare, unemployment insurance, pension accrual included",
          "FWO (Flanders) and FNRS (French-speaking) offer competitive PhD fellowships — prestigious career signals",
          "PhD years count toward the 5-year lawful residence requirement for permanent residency",
          "Belgian citizenship available after 5 years of legal residence with integration proof",
        ],
        outcome: "A Belgian PhD on an employment contract means 4 years of paid work experience in the EU with full social security. Combined with the lawful residence this builds, you can apply for permanent residency (D-card) after 5 years total — and citizenship thereafter.",
      },
      work: {
        intro: "The Belgian Single Permit is the primary work route for non-EU nationals — it combines work and residence permits in one employer-led application. Your employer submits to the regional authority (VDAB in Flanders, FOREM in Wallonia, Actiris in Brussels). Processing: 6–16 weeks. Brussels is particularly international — EU institutions, pharma, law firms, tech, and NGOs all hire non-EU talent regularly.",
        firstSteps: [
          { action: "Target employers experienced with non-EU sponsorship — Brussels and multinationals are best", detail: "EU institutions, international NGOs, pharma (UCB, Janssen, Solvay), Big Four firms, and multinational tech companies in Brussels and Antwerp deal with non-EU hires regularly. Smaller Flemish SMEs may be unfamiliar with the process." },
          { action: "Once you have a job offer, employer submits Single Permit application", detail: "Employer files with VDAB (Flanders), FOREM (Wallonia), or Actiris (Brussels). Required: your employment contract, qualifications, job description, salary proof, and a labour market test (unless exempt — EU Blue Card threshold is €45,141/year gross in 2024)." },
          { action: "Receive Annexe 46 and apply for Type D visa at Belgian Embassy Abuja", detail: "Once Belgian Immigration Office approves, Annexe 46 is issued. Apply for Type D long-stay visa at Belgian Embassy Abuja with: passport, Annexe 46, employment contract, accommodation proof, photos. Fee: ~€180." },
          { action: "Arrive and register at Commune within 8 days", detail: "Register your address. Inspector verifies. Receive Bijlage 15, then A-card (1-year residence permit). Renew each year through your Commune — begin 3 months before expiry." },
        ],
        keyFacts: [
          "EU Blue Card salary threshold: €45,141/year gross (2024) — exempts from labour market test",
          "Single Permit processing: 6–16 weeks after employer submits",
          "Belgian income tax: 25–50% progressive, but includes world-class social security benefits",
          "Brussels has Europe's highest concentration of EU institutions, NGOs, and international law firms",
          "Permanent residency (D-card) after 5 years of lawful residence",
        ],
        outcome: "Belgian Single Permit → annual renewals → D-card (permanent residency) after 5 years → Belgian citizenship after 5 years with integration proof. Belgian citizenship grants an EU passport, visa-free access to 180+ countries, and the right to live and work across all 27 EU member states.",
      },
      visitor: {
        intro: "Belgian visitor visas are Schengen short-stay Type C visas — valid for up to 90 days in any 180-day period across all 26 Schengen countries. Apply at the Belgian Embassy in Abuja or via VFS Global. Processing: 15 calendar days standard. Show clear purpose, strong ties to Nigeria, and sufficient funds (~€95/day).",
        firstSteps: [
          { action: "Book appointment at VFS Global Nigeria or Belgian Embassy Abuja", detail: "VFS Global handles Belgian Schengen visa applications in Nigeria. Applications must be submitted no more than 6 months and no less than 15 days before travel. Book as early as possible." },
          { action: "Gather documents: passport, funds proof, accommodation, insurance, Nigerian ties", detail: "Valid passport (3+ months beyond return date, 2 blank pages). Bank statements (3–6 months). Return flight itinerary. Hotel or host confirmation. Travel insurance (€30,000+ Schengen-wide coverage). Employment letter or business registration as proof of Nigerian ties." },
          { action: "Submit application and pay €80 fee — biometrics collected on the day", detail: "Bring originals and photocopies. VFS service fee applies in addition to the €80 embassy fee. Processing: 15 calendar days standard, up to 30 days for complex cases." },
        ],
        keyFacts: [
          "Belgian Schengen visa covers all 26 Schengen countries — Germany, France, Netherlands, Spain and more",
          "Fee: €80 adults, €40 children 6–12, free under 6",
          "Processing: 15 calendar days standard, up to 30 for complex cases",
          "Multiple-entry visas available if you have valid reason and prior Schengen travel history",
          "Funds requirement: ~€95/day recommended",
        ],
        outcome: "A Belgian Schengen visa opens access to 26 European countries for 90 days. Belgium itself offers Bruges, Ghent, Brussels, Antwerp, and the Ardennes — plus easy rail access to Amsterdam, Paris, London (Eurostar), and Cologne within 2 hours.",
      },
    },
...
- Multiple-entry visas are sometimes issued for frequent travellers — you must specifically request this and justify it`,
    ...
    timeline: {
      undergrad: [
        { step: "1", title: "Research & shortlist programmes", detail: "Research English-medium programmes at VUB, KU Leuven International, and University of Antwerp. Check language requirements — Dutch or French is required for most Belgian-medium undergrad programmes." },
        { step: "2", title: "Apply for VLIR-UOS or university scholarships (Sept–Feb)", detail: "If applying for VLIR-UOS scholarship, the window opens in September for the following academic year. Apply via vlir.be — the earlier the better." },
        { step: "3", title: "Submit university application (Jan–April)", detail: "Apply directly through each university's admissions portal. Submit transcripts, English proficiency test (IELTS 6.0+ typically), statement of purpose, and references." },
        { step: "4", title: "Receive admission letter (April–June)", detail: "Conditional or unconditional offer issued. Confirm your place and pay any deposit required. Obtain final acceptance letter for visa application." },
        { step: "5", title: "Apply for Belgian Type D student visa (allow 4–8 weeks)", detail: "Book appointment at Belgian Embassy Abuja or VFS. Submit passport, acceptance letter, proof of funds, accommodation proof, insurance, photos. Fee: ~€180. Processing: 4–8 weeks." },
        { step: "6", title: "Register at Commune within 8 days of arrival", detail: "Register your address at the local Commune immediately. Inspector visits to verify. Receive CIRE card within a few weeks. This is mandatory — failure to register is a legal violation." },
        { step: "7", title: "Settle and begin studies (September)", detail: "Open Belgian bank account (KBC, BNP Paribas Fortis, Belfius). Get student MOBIB transit card. Register with the university health plan (mutualiteit)." },
      ],
      masters: [
        { step: "1", title: "Research VLIR-UOS eligible programmes (August–September)", detail: "The VLIR-UOS list of eligible Master's programmes for Nigerian applicants is published in September. Study it carefully — only listed programmes are eligible for the scholarship." },
        { step: "2", title: "Submit VLIR-UOS application (October–February)", detail: "Apply via vlir.be — typically closes late January/early February. You may apply to up to 3 programmes simultaneously. Requires transcripts, CV, motivation letter, references, English proficiency proof." },
        { step: "3", title: "Apply directly to universities in parallel (October–March)", detail: "Apply directly to universities in case VLIR-UOS is unsuccessful. KU Leuven, Ghent, VUB all have online application portals. Some have rolling admissions; others close in March." },
        { step: "4", title: "Receive admission decisions (March–May)", detail: "VLIR-UOS selection results typically come in March–May. University direct offers typically follow shortly. Accept your place and confirm." },
        { step: "5", title: "Apply for Belgian Type D student visa (April–July)", detail: "Apply at Belgian Embassy Abuja or VFS with: passport, acceptance letter, scholarship letter (if applicable) or proof of funds, accommodation, insurance. Fee: ~€180. Allow 4–8 weeks." },
        { step: "6", title: "Arrive and register at Commune (August–September)", detail: "Arrive in Belgium, register at Commune within 8 days. Receive CIRE residence card. Open bank account. Register at the university health fund." },
        { step: "7", title: "Complete studies and apply for job-search permit", detail: "Most Belgian Master's are 60 ECTS (1 year) or 120 ECTS (2 years). After graduation, apply for 12-month job-search permit. Use LinkedIn, VDAB.be (Flanders jobs), Actiris.be (Brussels jobs)." },
      ],
      phd: [
        { step: "1", title: "Find a funded PhD position (6–12 months ahead)", detail: "Search academictransfer.com, FWO.be, FNRS.be, KU Leuven jobs portal, Ghent University jobs, and ResearchGate. Apply with CV, research statement, transcripts, and references." },
        { step: "2", title: "Receive employment contract or funding letter", detail: "University HR processes your contract. For employee-contract PhDs: Single Permit route. For scholarship-funded PhDs: student visa route." },
        { step: "3", title: "University submits Single Permit (6–16 weeks)", detail: "University HR submits Single Permit application to VDAB (Flanders), FOREM (Wallonia), or Actiris (Brussels). You do not submit this yourself. They receive Annexe 46 approval." },
        { step: "4", title: "Apply for Type D visa at Belgian Embassy Abuja (3–6 weeks)", detail: "With Annexe 46 in hand, apply for a long-stay Type D visa at the Belgian Embassy in Abuja. Bring: passport, Annexe 46, employment contract, accommodation proof, photos. Fee: ~€180." },
        { step: "5", title: "Arrive and register at Commune within 8 days", detail: "Register at local Commune. Receive temporary Bijlage 15, then A-card (1-year residence permit). Your A-card is renewable annually and tied to your employment contract." },
        { step: "6", title: "Complete PhD research (4 years typical)", detail: "Annual contract renewals. Your employer (university) renews the Single Permit each year. Stay on top of residence card renewals — begin 3 months before expiry each year." },
        { step: "7", title: "Post-PhD: apply for D-card after 5 years total residence", detail: "PhD holders are well-positioned for EU Blue Card roles. With 5 cumulative years of lawful residence (including PhD years), you can apply for long-term residency D-card. Belgian citizenship possible at 5 years." },
      ],
      work: [
        { step: "1", title: "Job search targeting Belgian employers (3–6 months)", detail: "LinkedIn, Indeed.be, StepStone.be, VDAB.be, EUjobs.eu (EU institutions). Target sectors: pharma, fintech, EU institutions, NGOs, engineering. Tailor your CV to Belgian/European format — no photo, no age, focus on competencies." },
        { step: "2", title: "Secure job offer with employer willing to sponsor", detail: "Raise the Single Permit process early in the hiring process. Some Belgian employers are unfamiliar with non-EU sponsorship — bring information from werk.belgie.be. Brussels employers are more internationally experienced." },
        { step: "3", title: "Employer submits Single Permit application (6–16 weeks)", detail: "Employer submits to VDAB (Flanders), FOREM (Wallonia), or Actiris (Brussels) depending on workplace location. Documents: your contract, qualifications, job description, salary proof, labour market test (if not exempt)." },
        { step: "4", title: "Receive Annexe 46 from Immigration Office", detail: "Belgian Immigration Office (DVZ) issues Annexe 46 — the authorisation to work and reside. This is sent to your employer and to the Belgian Embassy in Nigeria." },
        { step: "5", title: "Apply for Type D visa at Belgian Embassy Abuja (3–6 weeks)", detail: "Apply for Type D long-stay visa at Belgian Embassy Abuja. Bring: passport, Annexe 46, employment contract, accommodation proof (temporary hotel accepted initially), photos. Fee: ~€180." },
        { step: "6", title: "Arrive in Belgium and register at Commune within 8 days", detail: "Register your address at the local Commune within 8 working days. Inspector visits. You receive Bijlage 15 first, then your A-card (electronic residence permit, valid 1 year, renewable)." },
        { step: "7", title: "Settle, integrate, and build toward PR", detail: "Open Belgian bank account (KBC, Belfius, ING Belgium). Register with a health insurance fund (mutualiteit/mutualité). Begin integration: language classes (Dutch in Flanders, French in Wallonia) supported by VDAB/FOREM. Apply for D-card after 5 years lawful residence." },
      ],
      visitor: [
        { step: "1", title: "Confirm purpose and travel dates (6–8 weeks before)", detail: "Confirm your reason for visiting Belgium. Tourism, business meetings, family visit, or attending a conference all require slightly different supporting documents." },
        { step: "2", title: "Gather required documents", detail: "Assemble: passport (3 months validity beyond return date), bank statements (3–6 months), accommodation proof, return flight itinerary, travel insurance (€30,000+ coverage), proof of Nigerian ties." },
        { step: "3", title: "Book VFS Global or Embassy appointment", detail: "VFS Global handles Belgian visa applications in Nigeria. Book appointment online. Application must be submitted not more than 6 months before travel and at least 15 days before." },
        { step: "4", title: "Submit application and pay €80 fee", detail: "Bring original documents plus photocopies. Biometrics collected. Fee: €80 for adults. VFS service fee applies separately." },
        { step: "5", title: "Wait for decision (15–30 calendar days)", detail: "Standard processing: 15 calendar days. Complex cases: up to 30 days. Track via VFS portal. Do not book non-refundable flights before visa is confirmed." },
        { step: "6", title: "Travel to Belgium within visa validity", detail: "Entry stamp in passport marks start of your 90-day Schengen allowance. Keep your entry and exit stamps — useful if you apply for future Schengen visas." },
      ],
    },

    tips: {
      undergrad: [
        { title: "English-taught options are limited", body: "Most Belgian undergraduate programmes are in Dutch or French. English-taught undergrad options are limited to VUB, KU Leuven (a few), and University of Antwerp. Confirm language requirements before applying." },
        { title: "VLIR-UOS is for Master's, not undergrad", body: "VLIR-UOS scholarships are primarily for Master's and Advanced Master's — not undergraduate. For undergrad funding, check each university's own scholarship pages and the Belgian Development Cooperation grants." },
        { title: "Commune registration is a legal requirement", body: "Register at your local Commune within 8 days of arrival — this is mandatory by law, not optional. Failure to register can jeopardize your residence card and future visa applications." },
        { title: "Understand Belgian academic culture", body: "Belgian universities use ECTS credits (30 per semester). Academic culture values independence and critical thinking — participation and thesis quality matter as much as exams." },
        { title: "Open a bank account as soon as possible", body: "KBC Youth accounts, Belfius, and BNP Paribas Fortis all offer student products. You'll need it for rent, SNCB/STIB transit pass, and health insurance (mutualiteit)." },
        { title: "Know Belgium's language regions", body: "Belgium has three official language regions: Dutch-speaking Flanders, French-speaking Wallonia, and bilingual Brussels. In Brussels, English is widely spoken professionally. In Ghent and Leuven, Dutch is dominant day-to-day." },
        { title: "Budget food and living costs wisely", body: "Aldi and Lidl are everywhere. Average weekly grocery spend for a student is €40–60. Student restaurants (Alma restaurants at KU Leuven, for example) offer subsidised hot meals for €2–4." },
      ],
      masters: [
        { title: "VLIR-UOS is one of the best scholarships for Nigerians", body: "The VLIR-UOS scholarship is fully funded — comparable to Chevening in value. Apply early (September window, closes January/February). You can apply to up to 3 listed programmes simultaneously." },
        { title: "KU Leuven and Ghent degrees travel well across the EU", body: "KU Leuven and Ghent University are consistently in Europe's top 100. A degree from either institution is recognized across the EU and globally — valuable if your plan is EU-wide career mobility." },
        { title: "1-year Master's requires tight budget planning", body: "Belgian Master's programmes are typically 60 ECTS (1 year) or 120 ECTS (2 years). One-year Master's are common in STEM. Budget planning is important — you have less time to earn than in 2-year programmes." },
        { title: "Apply for job-search permit immediately after graduation", body: "Apply for the 12-month job-search permit (Attestation de Séjour pour Recherche d'emploi) as soon as you graduate. This keeps you legal in Belgium while job hunting. Do not leave Belgium and let your status lapse." },
        { title: "Brussels rewards bilingualism", body: "NGOs, EU institutions, and think tanks in Brussels actively recruit internationally educated graduates. Polishing your English and French gives you a genuine advantage in Brussels hiring." },
        { title: "Belgian CVs follow EU conventions", body: "No photo, no nationality, no age — 1–2 pages maximum. Focus on measurable achievements and competencies. LinkedIn is important — Belgian recruiters use it heavily." },
        { title: "Health insurance (mutualiteit) is mandatory", body: "Join a health fund (e.g. UNMS, Mutualité Chrétienne, OZ) within 3 months of registration. Student rates are subsidized. This covers GP visits, hospital stays, and prescriptions." },
      ],
      phd: [
        { title: "You are an employee — know your rights", body: "Belgian PhD students on employment contracts have full employment rights. Take your annual leave, join a union if you choose (CSC/ACV, FGTB/ABVV), and don't accept being treated as unlimited cheap labour by supervisors." },
        { title: "FWO and FNRS fellowships boost your career profile", body: "FWO (Flanders) and FNRS (French-speaking) fellowship competitions are prestigious career signals. Apply even if you already have a university contract — they can top up your funding." },
        { title: "Track your residence card renewal date carefully", body: "Annual residence card renewal is your responsibility even though your employer sponsors the permit. Mark your expiry date 3 months early and begin renewal. A lapsed card can mean being forced to leave Belgium." },
        { title: "PhD years count toward permanent residency", body: "A Belgian PhD counts toward the 5-year lawful residence requirement for permanent residency. So 4 years of PhD + 1 year of work can qualify you for a D-card (unlimited residence)." },
        { title: "Network across Belgium's international research community", body: "Belgian universities are highly international — you will meet researchers from across the EU and beyond. These connections form your post-PhD career pipeline: collaborations, postdoc offers, industry contacts." },
        { title: "Understand your tax situation in year one", body: "Employed PhD salaries are fully taxed. Some university-paid bursaries are partially tax-exempt. File Belgian taxes via Tax-on-Web (taxonweb.be) annually. Get clarity on your exact situation in your first year." },
        { title: "Start language learning from day one", body: "Learn Dutch (in Flanders) or French (in Wallonia/Brussels) — even at conversational level. It integrates you into daily life and is required for Belgian citizenship eventually. CBE language integration courses are free." },
      ],
      work: [
        { title: "Brussels is the EU capital — target it if you work in policy or law", body: "Brussels has the highest concentration of NGOs, EU institutions, international law firms, and think tanks per capita in Europe. If your skills are policy, law, economics, or international affairs, Brussels should be your first target." },
        { title: "High taxes — but excellent benefits in return", body: "Belgian income taxes are among the highest in Europe (up to 50% marginal rate). But Belgian social security provides world-class healthcare, generous unemployment insurance, and a real pension system. Factor this in when comparing offers with Gulf countries." },
        { title: "EU Blue Card exempts you from labour market test", body: "The EU Blue Card (€45,141/year gross threshold, 2024) exempts your employer from the labour market test and gives stronger EU mobility rights. If your salary qualifies, ask your employer to apply for it specifically instead of the standard Single Permit." },
        { title: "Brussels employers are more experienced with non-EU hires", body: "Belgian employer sponsorship experience varies hugely. Brussels-based multinationals and EU-sector employers deal with non-EU hires regularly. Smaller Flemish SMEs may be unfamiliar with the process — be ready to guide them to werk.belgie.be/en." },
        { title: "Look beyond Brussels: Antwerp, Ghent, and Leuven have strong sectors", body: "Antwerp is home to one of the world's busiest ports, a major diamond trade hub, and growing pharma/biotech. Ghent and Leuven have strong biotech and university spinout ecosystems. Consider these cities if your sector fits." },
        { title: "Start language learning from day one", body: "Flanders requires Dutch for most civil service roles and for citizenship integration tests. Brussels has Dutch and French pathways. Wallonia requires French. Language learning opens doors and is eventually required for citizenship." },
        { title: "Budget from your net salary — Belgian payslips are complex", body: "Your gross salary is significantly higher than your net take-home after 13.07% employee social security plus income tax (25–50%). Budget from your net salary. Use wagecoach.be or taxcalc.be to model your actual take-home." },
      ],
      visitor: [
        { title: "Be specific about your purpose of visit", body: "Vague answers are a red flag. 'I am visiting Brussels, Bruges, and Ghent for 10 days in July for tourism' is better than 'general travel interest.' Be specific about dates, places, and purpose." },
        { title: "Strong Nigerian ties documentation is essential", body: "Proof of ties to Nigeria is critical: employment contract, business registration, property deeds, family letter, letter from employer confirming your return. The embassy wants evidence you will leave Belgium when your visa expires." },
        { title: "A Belgian visa covers all 26 Schengen countries", body: "Your Belgian Type C visa lets you travel to Germany, France, the Netherlands, Spain, and 22 other Schengen countries within the 90/180 day limit. Plan your trip across multiple countries if you wish." },
        { title: "Belgium has more to offer than just Brussels", body: "Bruges, Ghent, Antwerp, and the Ardennes region are all worth visiting. Belgium has some of Europe's best beer culture (Trappist breweries), world-famous chocolate, and stunning medieval architecture." },
        { title: "Business visitors: get an official invitation letter", body: "For a business visit, bring an invitation letter from the Belgian company on official letterhead, stating the dates, purpose, and whether they will cover your accommodation. This significantly strengthens a business visa application." },
        { title: "Request multiple-entry if you have valid reasons", body: "Multiple-entry Schengen visas can be issued — request one explicitly if you have a valid reason (regular business, family visits). A history of Schengen visas with no overstays greatly improves your chances." },
        { title: "Travel insurance must be Schengen-wide and at least €30,000", body: "Travel insurance must cover the entire Schengen area for the full duration of your trip, with minimum €30,000 medical coverage. Buy from a reputable insurer — cheap policies sometimes exclude key conditions." },
      ],
    },

    universities: {
      undergrad: [
        { name: "VUB (Vrije Universiteit Brussel)", location: "Brussels", known_for: "International politics, law, sciences — English-medium undergrad programmes available", avg_tuition: "€4,175–8,350/year", acceptance: "Moderate", nigerian_community: "Active Nigerian and African student community in Brussels" },
        { name: "University of Antwerp", location: "Antwerp", known_for: "Law, applied economics, medicine, education science — some English-taught undergrad", avg_tuition: "€4,350–8,000/year", acceptance: "Moderate", nigerian_community: "Small but growing international student community" },
        { name: "KU Leuven", location: "Leuven (Flanders)", known_for: "Engineering, biomedical sciences, law, applied sciences — selected English-medium Bachelor programmes", avg_tuition: "€4,200–9,800/year", acceptance: "Selective", nigerian_community: "Large international student body; Nigerian students present across faculties" },
        { name: "Ghent University", location: "Ghent (Flanders)", known_for: "Bioscience, veterinary medicine, agriculture, engineering — limited English undergrad options", avg_tuition: "€4,000–8,000/year", acceptance: "Selective", nigerian_community: "International student community; Dutch-medium for most undergrad" },
      ],
      masters: [
        { name: "KU Leuven", location: "Leuven (Flanders)", known_for: "Engineering, biomedical sciences, law, theology — top 50 in Europe, most Master's in English", avg_tuition: "€4,200–9,800/year", acceptance: "Selective", nigerian_community: "Active Nigerian students association; VLIR-UOS recipients common" },
        { name: "Ghent University", location: "Ghent (Flanders)", known_for: "Bioscience, agriculture, engineering, veterinary medicine — top 100 globally", avg_tuition: "€4,000–8,000/year", acceptance: "Selective", nigerian_community: "Strong international community; VLIR-UOS eligible programmes" },
        { name: "VUB (Vrije Universiteit Brussel)", location: "Brussels", known_for: "International relations, law, sciences — Brussels location near EU institutions", avg_tuition: "€4,175–8,350/year", acceptance: "Moderate", nigerian_community: "Active African student networks; English working language" },
        { name: "UCLouvain", location: "Louvain-la-Neuve (Wallonia)", known_for: "Engineering, management, medicine, law — French-medium, VLIR-UOS eligible", avg_tuition: "€4,175–4,500/year", acceptance: "Selective", nigerian_community: "Francophone Nigerian community; French required" },
        { name: "University of Antwerp", location: "Antwerp", known_for: "Law, applied economics, development economics — English-medium Master's available", avg_tuition: "€4,350–8,000/year", acceptance: "Moderate", nigerian_community: "International student base; Antwerp has an established Nigerian community" },
        { name: "University of Liège (ULiège)", location: "Liège (Wallonia)", known_for: "Aerospace engineering, materials science, biomedical research — home of Space Centre de Liège", avg_tuition: "€4,175/year (EU-level for many)", acceptance: "Moderate", nigerian_community: "French-speaking environment; smaller international community" },
      ],
      phd: [
        { name: "KU Leuven", location: "Leuven (Flanders)", known_for: "Europe's most research-intensive university — engineering, biomedical, law, social sciences", avg_tuition: "Funded (employment contract ~€2,000–2,500/month net)", acceptance: "Competitive (merit + supervisor match)", nigerian_community: "Nigerian PhD researchers across faculties; active African PhD community" },
        { name: "Ghent University", location: "Ghent (Flanders)", known_for: "Bioscience, agri-food, veterinary medicine, engineering — FWO fellowship host", avg_tuition: "Funded (employment contract ~€2,000–2,500/month net)", acceptance: "Competitive (merit + supervisor match)", nigerian_community: "International research community; VLIR-UOS ICP PhD host" },
        { name: "VUB", location: "Brussels", known_for: "Social sciences, law, sciences — Brussels proximity to EU institutions and international bodies", avg_tuition: "Funded (employment contract or bursary)", acceptance: "Competitive", nigerian_community: "Active African academic networks; English working language" },
        { name: "UCLouvain", location: "Louvain-la-Neuve (Wallonia)", known_for: "Engineering, medicine, management, law — FNRS fellowship host (French-speaking)", avg_tuition: "Funded (FNRS or employment contract)", acceptance: "Competitive", nigerian_community: "Francophone Nigerian researchers; French required" },
        { name: "Hasselt University", location: "Hasselt (Flanders)", known_for: "Transportation sciences, biomedical sciences, architecture — smaller, more accessible", avg_tuition: "Funded (employment contract)", acceptance: "Moderate", nigerian_community: "Smaller international community; affordable Flemish city" },
      ],
    },
    ...
    summary: {
      undergrad: {
        ...
        firstSteps: [
          ...
          { action: "Apply to Licence programmes via Parcoursup (January–mid March)", detail: "Use your Campus France number to apply through parcoursup.fr. Submit transcripts, DELF score, and motivation letter. Most public university applications are free." },
      ...
      masters: {
        ...
        firstSteps: [
          ...
          { action: "Apply to universities (October–March) and request Eiffel nomination", detail: "Apply directly to each university. Sciences Po, HEC, Sorbonne, and Paris-Saclay have their own portals. After securing admission, ask admissions about Eiffel nomination — universities nominate you, you do not apply directly." },
        ...
        outcome: "A French Master's (Sorbonne, Sciences Po, Paris-Saclay) opens the EU job market and is recognized globally. After graduation: 12-month CdS RECE → Talent Passport (employer-led) → Carte de Résident after 5 years total lawful residence. The Eiffel scholarship makes this one of the most affordable elite Master's pathways in the world for Nigerians.",
      },
      phd: {
        intro: "PhD students at French public universities pay ~€391/year in fees. Most funded positions come with a contrat doctoral at ~€2,025/month gross — a real employment contract with full social security. The CIFRE scheme pays up to €2,700/month for industrial PhDs. After completing your PhD, Nigerian graduates receive 12 months on the CdS RECE job-search permit (not 24 months — Nigeria has no bilateral agreement with France for the extended version).",
        firstSteps: [
          { action: "Find a funded PhD position on ADUM, ABG, or university portals (6–12 months ahead)", detail: "Search adum.fr, abg.asso.fr, individual university PhD listings, and CNRS job portals. Email potential supervisors directly with your research proposal and CV — cold contact is normal in French academia." },
          { action: "Receive contrat doctoral or convention d'accueil from university", detail: "For employed PhDs: you get a contrat doctoral (employment contract at ~€2,025/month gross). For scholarship-funded PhDs: a convention d'accueil (hosting agreement). You need one of these before applying for a visa." },
          { action: "Apply for Talent Passport – Chercheur visa (employed) or VLS-TS (scholarship)", detail: "For employed PhD: Talent Passport – Chercheur route at TLScontact Nigeria. Bring convention d'accueil + contract + accommodation proof. Long-stay fee: €220. For scholarship PhD: Campus France then VLS-TS student visa route." },
          { action: "Validate OFII within 3 months of arrival", detail: "Validate your visa online at administration-etrangers-en-france.interieur.gouv.fr, pay €75 OFII fee online. Then register at the Préfecture or ANEF portal for your Titre de Séjour residence card." },
        ],
        keyFacts: [
          "PhD tuition: ~€391/year at public universities",
      ...
      work: {
        intro: "The Talent Passport – Salarié qualifié (reformed August 2025) is France's primary high-skill work permit. Salary threshold is €39,582/year gross (verify at service-public.fr — this is reviewed annually). Valid 4 years, employer-led. The EU Blue Card threshold is €59,373/year gross. After 5 years of lawful residence, apply for a carte de résident. Citizenship at 5 years with B1 French and integration proof.",
        firstSteps: [
          { action: "Secure a job offer above €39,582/year gross from a French employer", detail: "Negotiate your package above the Talent Passport threshold. For EU Blue Card (stronger EU mobility), target above €59,373/year. Confirm employer is willing to sponsor. Target multinationals, EU institutions (UNESCO, OECD), aerospace (Airbus in Toulouse), pharma (Sanofi), or tech (Station F ecosystem)." },
          { action: "Employer files work authorisation with DRIEETS (4–8 weeks)", detail: "Employer submits to DRIEETS (regional labour authority). Labour market test may apply for some roles — Talent Passport salary levels are expedited. Employer tracks the application. You will receive the authorisation document." },
          { action: "Apply for Talent Passport long-stay visa at TLScontact Nigeria (3–6 weeks)", detail: "Apply via france-visas.gouv.fr and book TLScontact appointment (TLS replaced VFS from April 2025). Documents: passport, job contract, work authorisation, degree certificates, accommodation proof, photos. Long-stay fee: €220." },
          { action: "Validate OFII and get Titre de Séjour residence card on arrival", detail: "Validate VLS-TS online within 3 months. Attend OFII appointment — sign the Republican Integration Contract (CIR), mandatory for all new immigrants. Apply for your Talent Passport Titre de Séjour at the ANEF portal — valid up to 4 years." },
        ],
        keyFacts: [
          "Talent Passport salary threshold: €39,582/year gross (updated August 2025 — verify at service-public.fr)",
          "EU Blue Card threshold: €59,373/year gross — stronger EU-wide mobility rights",
          "Permit duration: 4 years, renewable",
          "Long-stay visa fee: €220 (updated April 2025); short-stay Schengen: €80",
          "Permanent residency (carte de résident) after 5 years lawful residence; citizenship at 5 years with B1 French",
        ],
        outcome: "France → Talent Passport (4 years) → Carte de Résident after 5 years → French citizenship at 5 years with B1 French and integration record. Paris is the hub for international organisations (UNESCO, OECD), aerospace (Airbus), luxury (LVMH), pharma (Sanofi), and the world's largest startup campus (Station F).",
      },
      visitor: {
        intro: "The French short-stay visa is a Schengen Type C visa — 90 days in any 180-day period. Since April 18, 2025, France switched from VFS Global to TLScontact for visa submissions in Nigeria. Start your application at france-visas.gouv.fr first, then book a TLScontact appointment. Short-stay visitor fee remains €80. Processing: 15 days standard, up to 45 days peak season.",
        firstSteps: [
          { action: "Complete the online application at france-visas.gouv.fr", detail: "Create an account, choose 'short-stay' / tourism or business, complete the form, and generate your printed application with barcode. This step is mandatory before any TLScontact appointment." },
          { action: "Gather documents: passport, funds proof, accommodation, insurance, Nigerian ties", detail: "Valid passport (3+ months beyond return date, 2 blank pages). Bank statements 3–6 months (min €65/day). Return flight itinerary. Hotel or host letter. Travel insurance (€30,000+ Schengen-wide). Employment letter or business registration as proof of Nigerian ties." },
          { action: "Book and attend TLScontact appointment in Lagos or Abuja", detail: "Book at tlscontact.com — TLS replaced VFS for France from April 2025. Bring originals and photocopies of every document. Biometrics collected. Pay €80 visa fee + TLScontact service fee (~₦15,000–20,000)." },
        ],
        keyFacts: [
          "Short-stay Schengen visa: 90 days max in any 180-day period across all 26 Schengen countries",
          "Fee: €80 adults, €40 children 6–11, free under 6",
          "Apply via france-visas.gouv.fr first, then book TLScontact appointment (not VFS — changed April 2025)",
          "Processing: 15 calendar days standard, up to 45 days peak season",
          "Proof of funds: €65/day minimum, €120/day recommended for Paris",
        ],
        outcome: "A French Schengen visa opens access to 26 European countries. France offers Paris (Eiffel Tower, Le Marais, Versailles), the Loire Valley, Nice and the French Riviera, Lyon, and Bordeaux. Eurostar from Paris reaches London in 2h15 min; TGV reaches Brussels in 1h20 min.",
      },
    },

    visa: {
      undergrad: `**French Long-Stay Student Visa (VLS-TS Étudiant) — Undergraduate**

**Step 1: French language preparation**
Most French undergraduate programmes require B2–C1 French (DELF/DALF or TCF). Begin preparation early — this is the biggest barrier for Nigerian students. Alliance Française Lagos, Abuja, and Kano offer DELF preparation. Some Grandes Écoles preparatory paths have English-medium options but are highly selective.

**Step 2: Campus France Nigeria — mandatory pre-application**
...
Use your Campus France number to apply directly to universities via their online portals. For IUT (Instituts Universitaires de Technologie) and Licence programmes at public universities, apply through Parcoursup (parcoursup.fr) for September intake — deadline is typically mid-March.
...
- Proof of financial resources: €615/month minimum (bank statements, scholarship letter, or sponsor letter)
...
**Working rights:** You can work up to 964 hours per year (approximately 60% of a full-time contract = about 20 hrs/week). No separate work permit needed — it is included in your student visa status.`,

      masters: `**French Long-Stay Student Visa (VLS-TS Étudiant) — Master's**

The process mirrors the undergraduate route but with a richer scholarship landscape and more English-medium options.
...
**Top English-medium Master's institutions:**
- Sciences Po Paris — international affairs, political science, economics (fully English-medium)
- HEC Paris — MBA, management (English)
- INSEAD (Fontainebleau) — MBA (English, top 5 globally)
- Sorbonne Université — science and humanities Master's (many English options)
- Université Paris-Saclay — sciences, maths, engineering (top 15 globally for natural sciences)
- CentraleSupélec — engineering (English-medium options)
- ESSEC Business School — management, finance (English)
- IMT Atlantique — engineering (English-medium Master's)
...
Most funded French PhDs come through:
- University doctoral contract (contrat doctoral) — search on ADUM (adum.fr), ABG (abg.asso.fr), and each university's own listings
- CIFRE (Convention Industrielle de Formation par la REcherche) — industrial PhD with a company partner, salary up to €2,700/month gross, funded by ANRT
- Eiffel Doctorat — prestigious scholarship for international PhD students in specific disciplines, nominated by French institutions
- ANR (Agence Nationale de la Recherche) project grants — supervisors hire PhD students from project funding

**Visa route for funded PhD students:**
If your PhD comes with a doctoral contract (employment contract), apply for a **Passeport Talent — chercheur** (Talent Passport — Researcher). This is separate from the student visa and gives more rights.

If your PhD comes with a scholarship (not a salary), apply for a **VLS-TS student visa** via Campus France Nigeria.
...
**PhD structure in France:**
- Typically 3 years (funded contract), with possible 1-year extension
- Enrolment at a doctoral school (école doctorale) — mandatory training courses in addition to research
...
- INRIA — computer science and mathematics research
- INSERM — biomedical and health research
- CEA — energy, physics, IT research
- Institut Pasteur — infectious diseases (relevant for Nigerian researchers in public health)`,

      work: `**Passeport Talent — Working in France**

The Passeport Talent is France's flagship skilled worker permit. It covers multiple profiles under one 4-year permit:
...
5. **Artiste-interprète (Performer/Artist):** For professional artists and performers with a French contract.
...
- Employer's KBIS (business registration)
...
Step 5: Before your VLS-TS expires (typically after 1 year), apply at the Préfecture (or ANEF portal) for your Passeport Talent residence card — valid for the remaining period up to 4 years total.

**Key sectors in France hiring internationally:**
- Aerospace and defence: Airbus (Toulouse), Safran, Thales, Dassault
- Tech and startups: Station F ecosystem (Paris), Doctolib, Criteo, Deezer, BlaBlaCar
- Luxury and fashion: LVMH, Kering, L'Oréal, Hermès (Paris)
- Pharmaceuticals: Sanofi, Ipsen, Servier
- Energy: TotalEnergies, EDF, Engie
- Finance: BNP Paribas, Société Générale, Crédit Agricole, AXA
- Consulting: McKinsey, BCG, Bain, Big Four all have major Paris offices
- International organisations: UNESCO, OECD, ICC (all Paris-based)

**Path to permanent residency:**
After 5 years of lawful residence (student years count), apply for a carte de résident (10-year renewable permit). French citizenship (naturalisation) is available after 5 years of residence, subject to language test (B1 French minimum), civic knowledge test, and proof of integration.`,

      visitor: `**French Schengen Visitor Visa (Type C)**

France is in the Schengen Area. A French short-stay visa allows up to 90 days in any 180-day period across all 26 Schengen countries.
...
- Printed and signed france-visas application form
- 2 recent passport-size photographs (35x45mm, white background)
- Travel itinerary (return flight booking — hold booking acceptable)
- Proof of accommodation: hotel bookings, Airbnb, invitation letter from host in France
- Travel and medical insurance: minimum €30,000 coverage, valid for entire Schengen area and duration of trip. Buy from a reputable insurer.
- Proof of financial means: bank statements for 3–6 months. Minimum €65/day recommended (€120/day for Paris). For a 14-day Paris trip: show at least €1,700 available.
...
**Tips for Nigerian applicants:**
- France is one of the more thorough Schengen visa processors — present a clean, organized application. Tabs and a cover letter summarizing your trip improve first impressions.
- If you have previously traveled to Schengen countries without issues, mention this and attach copies of those stamps.
- A strong bank statement matters most — the French consulate pays attention to financial credibility.
- If you are visiting family/friends in France, the host can submit a private accommodation declaration (attestation d'accueil) stamped by their Mairie — this is very helpful.
- Multiple-entry visas are possible if you have a legitimate recurring reason (business, family). Request explicitly.
- Paris is expensive — plan your budget carefully. Montmartre, Le Marais, Versailles, the Loire Valley, Nice, and Lyon are all worth visiting.`,
    },

    timeline: {
      undergrad: [
        { step: "1", title: "French language preparation (6–18 months ahead)", detail: "Enroll at Alliance Française Lagos, Abuja, or Kano. Aim for DELF B2 minimum, C1 preferred for most Licence programmes. This is the most critical preparation step." },
        { step: "2", title: "Campus France Nigeria registration (October–December)", detail: "Register at nigeria.campusfrance.org, complete your DAP file, pay the Campus France fee (₦80,000 in 2025/26), and book your mandatory interview in Lagos or Abuja. Application deadline is December 1; interviews run November–March." },
        { step: "3", title: "University applications via Parcoursup (January–mid March)", detail: "Apply to Licence programmes through parcoursup.fr. Submit your Campus France number, transcripts, and motivation letter. Most public universities are free to apply." },
        { step: "4", title: "Receive admission decisions (May–June)", detail: "Parcoursup releases decisions in late May. You rank and confirm your choice. Some universities make rolling offers — accept promptly." },
        { step: "5", title: "Apply for VLS-TS student visa (June–July)", detail: "Apply at france-visas.gouv.fr, book TLScontact appointment (TLS replaced VFS for France in Nigeria from April 2025). Documents: passport, Campus France attestation, enrolment letter, proof of €615/month, accommodation proof, photos, insurance. Long-stay fee: €220." },
        { step: "6", title: "Arrive and validate OFII within 3 months", detail: "Within 3 months of arrival, validate your VLS-TS online at administration-etrangers-en-france.interieur.gouv.fr. Pay €75 OFII fee online. Fully digital — mandatory, not optional." },
        { step: "7", title: "Set up CROUS housing and bank account", detail: "If you booked CROUS student housing (résidence universitaire), move in. Open a French bank account (Boursorama, Société Générale, or BNP offer student accounts for internationals)." },
        { step: "8", title: "Renew titre de séjour annually and build French skills", detail: "Renew titre de séjour annually via ANEF portal before expiry. Attend OFII civic integration sessions. Build French language skills — B1 minimum required for citizenship eventually." },
      ],
      masters: [
        { step: "1", title: "Research Eiffel-eligible programmes (August–October)", detail: "Check campusfrance.org/en/eiffel-scholarship-program-excellence for the list of eligible institutions and disciplines. Identify 2–3 target institutions and contact potential supervisors or admissions offices." },
        { step: "2", title: "Register on Campus France Nigeria (October–November)", detail: "Register at nigeria.campusfrance.org, complete your DAP, attend the mandatory interview. Required before any French institution will process your application." },
        { step: "3", title: "Apply to universities and request Eiffel nomination (October–February)", detail: "Apply directly to universities. Sciences Po, HEC, Sorbonne, and Paris-Saclay all have their own portals. Deadlines December–March. You cannot apply directly for Eiffel — the university nominates you. Secure admission first, then ask about nomination." },
        { step: "4", title: "Receive offer, confirm, and secure accommodation (February–May)", detail: "Once you have your acceptance letter, confirm your place. Apply for CROUS student housing (trouverunlogement.lescrous.fr). CROUS application opens from January — apply early." },
        { step: "5", title: "Apply for VLS-TS student visa (May–July)", detail: "Apply via france-visas.gouv.fr + TLScontact Nigeria. Proof of funds: scholarship letter (if Eiffel) or €615/month in bank. Long-stay fee: €220 (Eiffel holders exempt). Processing: 15–45 days." },
        { step: "6", title: "Arrive, validate OFII, and set up essentials (August–September)", detail: "Validate VLS-TS online within 3 months of arrival. Attend OFII appointment. Open bank account, get Navigo transit card (Paris), register with your university health service." },
        { step: "7", title: "Apply for CdS RECE before student permit expires", detail: "Apply for the CdS RECE (Carte de Séjour – Recherche d'Emploi) at the ANEF portal. Gives you 12 months to find qualifying employment. Not renewable — transition to Talent Passport within this period." },
      ],
      phd: [
        { step: "1", title: "Find a funded PhD position (6–12 months ahead)", detail: "Search ADUM (adum.fr), ABG (abg.asso.fr), CNRS job portal, and individual university PhD listings. Email potential supervisors directly with your research proposal and CV — cold contact is normal in French academia." },
        { step: "2", title: "Receive contrat doctoral or convention d'accueil (1–3 months)", detail: "University HR prepares your contrat doctoral (employment contract) or convention d'accueil (hosting agreement for scholarship-funded PhDs). You need one of these documents before applying for the visa." },
        { step: "3", title: "Apply for Talent Passport chercheur visa (employed) or VLS-TS (scholarship)", detail: "Apply at the French Embassy Abuja or TLScontact Nigeria. For Talent Passport: bring convention d'accueil + contract + accommodation proof. For VLS-TS student: Campus France process first. Long-stay fee: €220." },
        { step: "4", title: "Arrive and validate OFII within 3 months", detail: "Validate visa online, attend OFII appointment. Register at the Préfecture (or ANEF) to receive your Titre de Séjour (residence card)." },
        { step: "5", title: "Enroll at your doctoral school (September–October)", detail: "All French PhDs enroll at an école doctorale. Complete mandatory training hours. Annual thesis committee (CSI) review required — keep records." },
        { step: "6", title: "Complete research and renew residence card annually (3 years)", detail: "Annual contract renewals for doctoral contract. Renew residence card annually via ANEF portal. Budget for city costs on your doctoral salary (~€2,025/month gross)." },
        { step: "7", title: "Apply for CdS RECE after thesis defence (12 months for Nigerians)", detail: "Apply for the CdS RECE before your residence card expires. Nigerian graduates receive 12 months — not 2 years. Not renewable. Secure a job and switch to Talent Passport within those 12 months." },
      ],
      work: [
        { step: "1", title: "Job search targeting French market (3–6 months)", detail: "LinkedIn, Welcome to the Jungle (wttj.co), Indeed.fr, Cadremploi.fr, APEC (apec.fr for executives). French CV format: no photo, 1–2 pages, professional summary at top. Cover letters (lettres de motivation) are standard." },
        { step: "2", title: "Secure job offer above €39,582/year gross", detail: "Negotiate your package above the Talent Passport threshold (€39,582/yr, updated August 2025). For EU Blue Card (stronger EU mobility), target above €59,373/year. Confirm employer is willing to sponsor the permit." },
        { step: "3", title: "Employer files work authorisation with DRIEETS (4–8 weeks)", detail: "Employer files with DRIEETS (regional labour authority) for work permit authorisation. Labour market test may apply for some roles — Talent Passport roles are expedited. Employer tracks the application." },
        { step: "4", title: "Apply for Talent Passport long-stay visa at TLScontact Nigeria (3–6 weeks)", detail: "Apply at france-visas.gouv.fr and book TLScontact appointment. Documents: passport, job contract, work authorisation, degree certificates, accommodation proof, photos. Long-stay fee: €220 (from April 2025)." },
        { step: "5", title: "Arrive France and validate OFII within 3 months", detail: "Validate VLS-TS online within 3 months. Attend OFII appointment. Sign the Republican Integration Contract (CIR) — mandatory for all new immigrants. Start French language classes if required." },
        { step: "6", title: "Apply for Talent Passport Titre de Séjour at ANEF portal", detail: "Apply for your residence card at the local Préfecture or via ANEF (administration-etrangers-en-france.interieur.gouv.fr). Card is valid up to 4 years. Begin renewal before expiry." },
        { step: "7", title: "Build toward permanent residency after 5 years", detail: "Complete French language classes (B1 required for citizenship). After 5 years, apply for carte de résident (permanent residence). Citizenship available at 5 years with strong integration record." },
      ],
      visitor: [
        { step: "1", title: "Start application on france-visas.gouv.fr (4–6 weeks before)", detail: "Create an account, choose your visa type (short-stay tourism/business), complete the form, generate and print the application confirmation with barcode." },
        { step: "2", title: "Gather all required documents", detail: "Passport, photos, travel insurance (€30,000+ for full Schengen), accommodation proof, return flight itinerary, bank statements (3–6 months), proof of employment/ties to Nigeria." },
        { step: "3", title: "Book and attend TLScontact appointment in Lagos or Abuja", detail: "Bring originals AND photocopies of every document. Biometrics collected. Pay €80 visa fee + TLScontact service fee (~₦15,000–20,000). Keep your receipt. Book at tlscontact.com." },
        { step: "4", title: "Wait for decision (15–45 calendar days)", detail: "Track status via TLScontact portal. French visas are typically decided in 15 days. Peak season (June–September) can be longer — apply earlier. Do not book non-refundable flights before visa is confirmed." },
        { step: "5", title: "Collect passport and travel within visa validity", detail: "Collect passport from TLScontact. Check visa validity dates carefully — ensure they cover your travel period. 90 days max in any 180-day Schengen period." },
      ],
    },
    ...
    tips: {
      ...
      masters: [
        ...
        { title: "Lyon, Toulouse, and Bordeaux offer top education at lower cost", body: "Paris is expensive — budget €1,300–1,800/month minimum. Lyon, Toulouse, Bordeaux, and Montpellier offer equivalent quality education for €800–1,100/month. Consider these cities seriously." },
        { title: "Join your Grandes Écoles alumni network immediately", body: "Networking in France works through grandes écoles alumni networks. Sciences Po, HEC, and Polytechnique alumni networks are among the most powerful career tools in France and Europe — activate yours from day one." },
        { title: "Register with sécurité sociale and a mutuelle on arrival", body: "French healthcare is excellent and partially subsidised for residents. Register with sécurité sociale as soon as you arrive. Top up with a mutuelle (supplementary insurance) — student mutuelles like LMDE or HEYME cost around €25–50/month." },
      ],
      phd: [
        { title: "The contrat doctoral is a real employment contract — know your rights", body: "You have full French employee rights: 25 days annual leave, social security, and unemployment insurance eligibility after the PhD. Don't let supervisors treat PhD time as unlimited unpaid labour." },
        { title: "CIFRE industrial PhDs pay more and give industry experience", body: "CIFRE PhDs (with a company partner) pay ~€2,700/month gross and give industry experience alongside research. If your field overlaps with industry needs, this is worth pursuing. Search on anrt.asso.fr." },
        { title: "You get 12 months on CdS RECE — not 2 years", body: "Nigerian PhD graduates receive 12 months on the CdS RECE job-search permit, not 2 years. The 24-month version requires bilateral agreements Nigeria doesn't have. Use those 12 months actively — network, apply for postdocs and industry roles, and secure your Talent Passport before time runs out." },
        { title: "CNRS lab collaborations expand your post-PhD network", body: "CNRS joint labs (Unités Mixtes de Recherche) exist at almost every French university — collaborating with CNRS researchers expands your network significantly and can lead to postdoc positions and permanent research roles." },
        { title: "Keep all thesis committee records and know how to escalate disputes", body: "Annual thesis committee (CSI) reviews are mandatory and documented. Keep copies of all your progress reports. If your supervisor relationship becomes problematic, your doctoral school's mediator (référent déontologie) can help formally." },
        { title: "Paris for industry, Lyon and Toulouse for engineering", body: "If you want to transition from academia to industry, Paris gives the most options (Station F, luxury, finance, international organisations). Lyon and Toulouse are strong for engineering, aerospace, and pharma." },
        { title: "Start French conversational skills from day one", body: "French is not required for PhD research (many labs work in English) but it is required for citizenship and daily life. OFII integration classes are free and a practical starting point." },
      ],
      work: [
        { title: "Station F in Paris is the world's largest startup campus", body: "Station F (13th arrondissement, Paris) houses 1,000+ startups and accelerators including Meta, Microsoft, Google, and LVMH. If you work in tech or product, getting into a Station F company is a genuine career accelerator." },
        { title: "Negotiate for cadre (executive) status", body: "French job titles matter — cadre status gives you a different pay scale, better benefits, and access to the management pension scheme (AGIRC-ARRCO). Negotiate for cadre status when possible — it significantly improves your employment conditions." },
        { title: "Calculate your net salary carefully", body: "Income tax in France is progressive (0–45%) and there are additional social charges (~22%). Your take-home on €50,000 gross is roughly €32,000–34,000/year net. Use net-salary.fr or simulateur.net to model your actual take-home before accepting offers." },
        { title: "The Republican Integration Contract (CIR) is mandatory", body: "The CIR signed at OFII commits you to French language classes and civic formation sessions — these are free, scheduled by OFII, and genuinely useful. Language level assessed on arrival; some immigrants receive intensive hours based on their level." },
        { title: "Push for CDI (permanent contract) when possible", body: "French CDI (contrat à durée indéterminée) is the gold standard employment contract. CDDs (fixed-term) are common in entry-level roles. Prove yourself and push for CDI — it significantly improves housing, credit, and long-term stability." },
        { title: "Paris hosts UNESCO, OECD, and ICC — prime for policy careers", body: "If your background is policy, law, economics, or international development, Paris offers access to UNESCO, OECD, ICSID, and ICC — international organisations that barely exist outside New York, Geneva, and Vienna." },
        { title: "Apply for all government documents immediately on arrival", body: "French administration moves slowly. Apply for your residence card, tax number (numéro fiscal), and social security number immediately on arrival — don't wait until you need them urgently. The ANEF portal handles most immigration processes online." },
      ],
      visitor: [
        { title: "Start at france-visas.gouv.fr before any TLScontact appointment", body: "The online form on france-visas.gouv.fr generates a barcode application that you bring to TLScontact. Skipping this step and going directly to TLScontact will mean being turned away. Always start online." },
        { title: "Travel insurance must be Schengen-wide and at least €30,000", body: "Insurance must cover the full Schengen area (not just France), the full duration of your stay, with minimum €30,000 medical coverage. Buy from a well-known insurer — cheap policies with exclusions get rejected." },
        { title: "Apply 5–6 weeks ahead for summer travel", body: "Paris in July–August is peak season for both tourism and visa backlogs. Apply at least 5–6 weeks in advance. September–May is easier for appointments and faster processing." },
        { title: "Previous Schengen or international travel significantly helps", body: "Showing you have previously traveled internationally (UK, US, Canada, Schengen) and returned without overstaying is one of the strongest signals in a French visa application. Attach copies of past passport stamps." },
        { title: "Your French Schengen visa covers all of Europe", body: "Amsterdam, Brussels, and many other European cities are within 1.5–2 hours of Paris by train — your French Schengen visa covers all 26 Schengen countries. Plan your European trip efficiently." },
        { title: "Be honest about your purpose — especially family visits", body: "If you are visiting family in France, say so clearly and bring their titre de séjour copy and accommodation letter. Misrepresenting your visit purpose is grounds for refusal and potential future bans." },
        { title: "A refusal is addressable — respond to every specific reason", body: "A refusal letter explains the specific reason. Address every point directly in a fresh, stronger application. A prior refusal alone does not prevent future approval — but you must resolve the issues raised." },
      ],
    },
    ...
    universities: {
      ...
      phd: [
        ...
        { name: "Sorbonne Université", location: "Paris", known_for: "Sciences, humanities, medicine, law — major CNRS joint lab host; Institut Pasteur collaboration", avg_tuition: "~€391/year (funded positions: contrat doctoral)", acceptance: "Competitive", nigerian_community: "Large African PhD community in Paris" },
        { name: "Université Grenoble Alpes", location: "Grenoble", known_for: "Physics, mathematics, materials science, computer science — major CNRS and CEA research hub in the Alps", avg_tuition: "~€391/year (funded positions: contrat doctoral)", acceptance: "Competitive", nigerian_community: "Smaller international community; strong physics and engineering research" },
        { name: "Université Paul Sabatier (Toulouse III)", location: "Toulouse", known_for: "Aerospace, aeronautics, applied mathematics — co-located with Airbus, CNES, and major aerospace research", avg_tuition: "~€391/year (funded positions: contrat doctoral or CIFRE)", acceptance: "Competitive", nigerian_community: "International engineering research community; CIFRE positions available with Airbus partners" },
        { name: "Université de Bordeaux", location: "Bordeaux", known_for: "Neuroscience, biomedical research, chemistry — strong INSERM and CNRS lab presence", avg_tuition: "~€391/year (funded positions: contrat doctoral)", acceptance: "Moderate-Competitive", nigerian_community: "International PhD community; affordable city for PhD salary" },
      ],
    },

    scholarships: {
      undergrad: [
        { name: "Eiffel Excellence Scholarship (Master's reference)", amount: "Not available for undergraduate — listed here as a goal to work toward for Master's applications", university: "N/A for undergrad — apply after completing your Licence", deadline: "N/A for undergrad", url: "https://www.campusfrance.org/en/eiffel-scholarship-program-excellence" },
    ...
    embassy: {
      ...
      extra_links: [
        ...
        { label: "CIFRE industrial PhD programme — ANRT", url: "https://www.anrt.asso.fr/fr/le-dispositif-cifre-7844" },
        { label: "Parcoursup — French undergraduate admissions", url: "https://www.parcoursup.fr/" },
        { label: "CROUS — student housing applications", url: "https://www.messervices.etudiant.gouv.fr/" },
        { label: "Welcome to the Jungle — French job listings", url: "https://www.welcometothejungle.com/" },
        { label: "French Embassy Nigeria — general information", url: "https://ng.ambafrance.org/" },
      ],
    },
  },
...
Apply at the Spanish Embassy Abuja (Calle Yerma 16, Abuja) or via VFS Global Nigeria. Documents: passport (3+ months validity), return flight itinerary, hotel/accommodation confirmation, travel insurance (€30,000+ Schengen-wide), bank statements (€90/day minimum), proof of Nigerian employment or business ties, application form. Fee: €80. Processing: 15 days standard. Apply 3–4 weeks before travel.`,
  ...
  NZ: {
    ...
    summary: {
      undergrad: {
        intro: "New Zealand international student fees are NZD 22,000–38,000/year — expensive, but post-study work rights (up to 3 years after graduation) make the investment worthwhile if you plan to stay and work. The University of Auckland, Victoria University of Wellington, University of Otago, Canterbury, and Massey are the main institutions. Apply directly to universities. Student visa is applied online via Immigration New Zealand (INZ). Students can work 20 hours/week during term.",
        firstSteps: [
          { action: "Choose a university and apply directly online", detail: "Main intakes: February (Semester 1) and July (Semester 2). Apply 3–6 months before semester start. Key universities: University of Auckland (top 100 globally), Victoria University Wellington, Otago (medicine/marine science), Canterbury (engineering), Massey (agriculture/food tech). Apply via each university's online portal." },
          { action: "Get medical certificate and police clearance (allow 2–3 months)", detail: "Medical certificate (chest X-ray for TB screening) is required from an INZ-approved panel physician in Nigeria — find the list at immigration.govt.nz/medical. Police clearance from Nigerian Police Force. Start these early as they take time." },
          { action: "Apply for student visa online at visas.immigration.govt.nz", detail: "Upload: offer of place letter, passport, funds evidence (NZD 15,000/year in bank or scholarship letter), medical certificate, police clearance, English proficiency (IELTS 6.0+). Fee: NZD 375. Processing: 2–6 weeks." },
          { action: "Plan for Post-Study Work Visa from day one", detail: "After completing your degree, apply for the Post-Study Work Visa before your student visa expires. Bachelor's: 3 years open work rights. This lets you work for any employer — building toward the Skilled Migrant Category or Green List residency." },
        ],
        keyFacts: [
          "Tuition: NZD 22,000–38,000/year for international students",
          "Students can work 20 hrs/week during term, full-time in scheduled holidays",
          "Post-Study Work Visa: 3 years after Bachelor's/Master's/PhD — open work rights with any employer",
          "Medical certificate (chest X-ray) from INZ-approved panel physician in Nigeria required",
          "New Zealand citizenship after 5 years — dual nationality permitted, keep your Nigerian passport",
        ],
        outcome: "A New Zealand undergraduate degree from a top-100 university (Auckland) or specialist institution (Otago, Massey) leads to 3 years of open work rights. Use that time to accumulate Skilled Migrant Category points or secure a Green List job offer — and you're on track for permanent residency within 5–7 years.",
      },
      masters: {
        intro: "English-medium across all disciplines. NZ is strong in agriculture/food science (Massey), medicine and marine science (Otago), engineering (Canterbury, Auckland), and computer science (Auckland, Victoria). Fees: NZD 26,000–45,000/year. New Zealand Commonwealth Scholarships (fully funded) and University Excellence Scholarships are available. After graduation: 3-year Post-Study Work Visa. Many graduate roles qualify for the Green List — a direct fast-track to permanent residency.",
        firstSteps: [
          { action: "Apply for NZ Commonwealth Scholarship (fully funded) via Commonwealth Scholarship Commission Nigeria", detail: "The NZ Commonwealth Scholarship covers full tuition, NZD 20,000/year living allowance, return flights, and insurance. Applications open September–November annually via the Commonwealth Scholarship Commission Nigeria. Apply for this first." },
          { action: "Apply directly to universities with your undergraduate transcript and research proposal", detail: "Most Master's applications go through the university's online portal. Submissions: typically 3–6 months before intake. University Excellence Scholarships are applied with admission. Merit-based — submit strong academic results." },
          { action: "Apply for student visa online (offer letter → medical cert → police cert → visa)", detail: "Once you have your offer of place, apply for the student visa at visas.immigration.govt.nz. Upload offer letter, funds proof (scholarship letter or NZD 15,000/year), medical certificate, police clearance. Fee: NZD 375. Allow 2–6 weeks." },
          { action: "Identify Green List occupations in your field before you start your degree", detail: "Check immigration.govt.nz/green-list before you enrol. If your Master's leads to a Green List Tier 1 occupation (engineer, nurse, doctor, teacher), plan your post-graduation job search accordingly — qualifying roles give straight-to-residence." },
        ],
        keyFacts: [
          "NZ Commonwealth Scholarship: full tuition + NZD 20,000/year + return flights — apply September–November",
          "Post-Study Work Visa: 3 years open work rights after Master's — work for any employer",
          "Green List Tier 1 jobs → straight-to-permanent-residence (no points accumulation needed)",
          "University of Auckland is top 100 globally — degree internationally recognized",
          "Tuition: NZD 26,000–45,000/year for international Master's students",
        ],
        outcome: "NZ Master's → 3-year Post-Study Work Visa → Green List Tier 1 (straight-to-residency) or Skilled Migrant Category (180+ points) → Resident Visa → NZ citizenship at 5 years. The post-study work rights and Green List together make New Zealand one of the most achievable skilled-migrant pathways from Nigeria.",
      },
      phd: {
        intro: "PhD fees in New Zealand are subsidised to a near-domestic rate for most funded students — NZD 6,500–9,000/year. The New Zealand Doctoral Scholarship pays NZD 27,500/year stipend plus fees for top applicants. PhD graduates get a 3-year Post-Study Work Visa. If your PhD is in a Green List field (engineering, medicine, IT, environmental science), combining your degree with a qualifying job offer can lead to straight-to-permanent-residency.",
        firstSteps: [
          { action: "Email NZ academics directly with your research proposal and CV", detail: "Cold contact is normal and expected in NZ academia. Write a brief, specific email referencing their published research. Ask if they are taking PhD students. A supervisor's support is critical for the NZ Doctoral Scholarship nomination." },
          { action: "Apply for NZ Doctoral Scholarship through your chosen university", detail: "The NZ Doctoral Scholarship pays NZD 27,500/year + tuition fees for 3 years. Applications go through the university — deadlines vary, main intakes February and July. Apply with research proposal, CV, transcripts, and 2 references." },
          { action: "Apply for student visa online (medical cert + police cert required)", detail: "Apply at visas.immigration.govt.nz. Upload offer of place / scholarship letter, medical certificate from INZ-approved physician, police clearance, IELTS 6.5+. Fee: NZD 375. Processing: 2–6 weeks." },
          { action: "From year 2, research Green List jobs and build your NZ professional network", detail: "Network at conferences and with industry contacts. Identify Green List Tier 1 occupations in your field. A qualifying job offer after your PhD triggers straight-to-residence — plan this from mid-PhD onwards." },
        ],
        keyFacts: [
          "PhD tuition: NZD 6,500–9,000/year (near-domestic rate, often fully covered by scholarship)",
          "NZ Doctoral Scholarship: NZD 27,500/year + fees for 3 years — competitive",
          "Post-PhD: 3-year Post-Study Work Visa with open work rights",
          "Green List Tier 1 PhD field + qualifying job offer = straight-to-permanent-residency",
          "NZ research strengths: marine science, agriculture, geothermal, earthquake engineering, biomedical",
        ],
        outcome: "NZ PhD → 3-year Post-Study Work Visa → Green List Tier 1 job (straight-to-residency) or SMC points accumulation → Resident Visa → NZ citizenship at 5 years with dual nationality. The NZ Doctoral Scholarship makes this path financially accessible for strong applicants.",
      },
      work: {
        intro: "New Zealand has three main work-to-PR routes: (1) Accredited Employer Work Visa (AEWV) — employer must be INZ-accredited; (2) Skilled Migrant Category (SMC) — points-based, 180+ points required; (3) Green List — Tier 1 gives straight-to-permanent-residency for shortage occupations: doctors, nurses, engineers, secondary teachers (STEM), construction project managers. NZ actively recruits internationally — especially in healthcare.",
        firstSteps: [
          { action: "Identify whether your occupation is on the Green List before anything else", detail: "Check immigration.govt.nz/green-list. Tier 1 occupations (straight-to-residency): medical practitioners, nurses, civil/mechanical/electrical engineers, secondary school STEM teachers, construction project managers, and more. Tier 2 (2 years work first): broader list. This determines your entire strategy." },
          { action: "Secure a job offer from an INZ-accredited employer", detail: "Check the accredited employer register at immigration.govt.nz. Employer submits a Job Check to INZ before you can apply for AEWV. Health sector: register with MCNZ (medicine) or NCNZ (nursing) first — NZ registration requires degree verification and English test (IELTS 7.0 for nurses)." },
          { action: "Apply for Accredited Employer Work Visa (AEWV) online", detail: "Apply at visas.immigration.govt.nz. Documents: passport, job offer, qualifications, English proficiency (IELTS 5.0+ for most), medical certificate, police clearance. Fee: NZD 750. Processing: 2–4 weeks. AEWV is typically 3 years (extendable to 5)." },
          { action: "Apply for Resident Visa via Green List (immediately) or SMC (180+ points)", detail: "Green List Tier 1: apply for Resident Visa as soon as you have your qualifying job offer — no waiting period. SMC: submit Expression of Interest (EOI) once you have 180+ points; if selected, apply for Resident Visa. Citizenship after 5 years as resident — dual nationality allowed." },
        ],
        keyFacts: [
          "Green List Tier 1: straight-to-permanent-residency for qualifying shortage occupations — no points needed",
          "SMC: 180+ points from age, qualifications, NZ work experience, job offer",
          "AEWV fee: NZD 750; AEWV duration: 3 years (extendable to 5)",
          "Nurses require NCNZ registration (IELTS 7.0 in all bands); doctors require MCNZ registration",
          "NZ citizenship after 5 years as resident — dual nationality permitted, keep Nigerian passport",
        ],
        outcome: "AEWV (work entry) → Green List Tier 1 straight-to-residency or SMC 180+ points → Resident Visa (2 years) → Permanent Resident → NZ citizenship at 5 years. Dual nationality means you keep your Nigerian passport. An NZ passport gives visa-free access to 185+ countries.",
      },
      visitor: {
        intro: "New Zealand visitor visa allows up to 9 months in an 18-month period. Most applications are processed fully online via Immigration New Zealand (INZ) — no embassy visit required. Apply at visas.immigration.govt.nz. Processing: 2–4 weeks. NZ is not Schengen — this visa covers New Zealand only. Australia requires a separate visa.",
        firstSteps: [
          { action: "Apply online at visas.immigration.govt.nz", detail: "Create an INZ account, choose 'Visitor Visa', upload all documents. No embassy or VFS visit needed for most Nigerian applicants — fully online process. Fee: NZD 211 (~€115), paid by card." },
          { action: "Gather required documents", detail: "Valid passport, recent passport photo, evidence of funds (NZD 1,000/month via bank statements or credit card evidence), return or onward flight itinerary, accommodation plan (hotel/host letter), proof of Nigerian ties (employment letter, business registration, family)." },
          { action: "Wait for decision and respond quickly to any requests", detail: "Processing: 2–4 weeks online. INZ may request additional documents — respond within their stated deadline. Check your INZ account regularly." },
        ],
        keyFacts: [
          "Visitor visa: up to 9 months in an 18-month period",
          "Fully online application — no embassy or VFS visit required for most applicants",
          "Fee: NZD 211 (~€115)",
          "Processing: 2–4 weeks",
          "NZ visa covers New Zealand only — Australia requires a separate ETA or visa",
        ],
        outcome: "A New Zealand visitor visa opens Auckland, Wellington, Queenstown, Rotorua, the Bay of Islands, and Milford Sound — one of the most scenically spectacular countries in the world. Biosecurity is strict on arrival: declare all food, plant, and animal products or face heavy fines.",
      },
    },
...
Visitor visa allows up to 9 months in an 18-month period. Not a Schengen visa — covers New Zealand only. Australia requires a separate visa.`,
    ...
    timeline: {
      undergrad: [
        { step: "1", title: "Research universities and apply directly (6–12 months ahead)", detail: "Apply directly to NZ universities. Main intake: February (Semester 1) and July (Semester 2). Deadlines typically 2–3 months before semester start. Key portals: auckland.ac.nz, otago.ac.nz, canterbury.ac.nz, massey.ac.nz." },
        { step: "2", title: "Get medical certificate and police clearance (2–3 months ahead)", detail: "Medical certificate (chest X-ray for TB) from INZ-approved panel physician in Nigeria — list at immigration.govt.nz/medical. Police clearance from Nigerian Police Force. Start both early — they take time." },
        { step: "3", title: "Apply for student visa online at visas.immigration.govt.nz (6–8 weeks ahead)", detail: "Upload: offer of place, passport, funds proof (NZD 15,000/yr in bank or scholarship letter), medical cert, police clearance, IELTS 6.0+. Fee: NZD 375. Processing: 2–6 weeks." },
        { step: "4", title: "Arrive and set up in New Zealand (1–2 weeks before semester)", detail: "No registration required on arrival — your visa is your authorization. Open bank account (ANZ, BNZ, ASB, Westpac welcome international students with passport and offer letter)." },
        { step: "5", title: "Apply for Post-Study Work Visa before student visa expires", detail: "Apply online for 3-year open work visa (Bachelor's/Master's/PhD). Open work rights — work for any employer in any role. Use this time to build toward Green List or SMC residency." },
      ],
      masters: [
        { step: "1", title: "Apply for NZ Commonwealth Scholarship (September–November)", detail: "NZ Commonwealth Scholarship: full tuition + NZD 20,000/year + flights + insurance. Apply via Commonwealth Scholarship Commission Nigeria. Deadline typically October/November for the following year intake." },
        { step: "2", title: "Apply directly to universities with admission and Excellence Scholarship (3–6 months ahead)", detail: "Apply through each university's portal. University Excellence Scholarships are applied with admission — submit strong academic results. Merit-based, competitive." },
        { step: "3", title: "Complete medical + police cert, then apply for student visa online", detail: "Offer letter → medical certificate (INZ-approved physician) + police clearance → student visa at visas.immigration.govt.nz. Fee: NZD 375. Processing: 2–6 weeks." },
        { step: "4", title: "Research Green List occupations and job search during studies (Year 1–2)", detail: "Use Seek.co.nz, LinkedIn NZ, TradeMe Jobs. Network at university career fairs. Identify Green List Tier 1 occupations in your field — qualifying job offer after graduation triggers straight-to-residency." },
        { step: "5", title: "Apply for Post-Study Work Visa → Resident Visa", detail: "3-year open work visa after graduation → Green List Tier 1 (straight-to-residency) or build SMC 180+ points → Resident Visa → citizenship at 5 years." },
      ],
      phd: [
        { step: "1", title: "Contact NZ supervisors directly with research proposal (6–12 months ahead)", detail: "Email NZ academics directly — cold contact is expected. Reference their published research. A supervisor's support is critical for NZ Doctoral Scholarship nomination. Research strengths: marine science, agriculture, geothermal, earthquake engineering, biomedical." },
        { step: "2", title: "Apply for NZ Doctoral Scholarship through your university", detail: "NZD 27,500/year + tuition fees for 3 years. Applications go through the university — main intakes February and July. Submit research proposal, CV, transcripts, and 2 references." },
        { step: "3", title: "Apply for student visa online (medical + police cert required)", detail: "Apply at visas.immigration.govt.nz. Upload offer of place/scholarship letter, medical certificate, police clearance, IELTS 6.5+. Fee: NZD 375. Processing: 2–6 weeks." },
        { step: "4", title: "Complete PhD and network toward Green List job (3–4 years)", detail: "Student visa renewed annually. NZD 27,500/year stipend. Network at conferences from year 2 — identify Green List Tier 1 roles in your field. A qualifying job offer after PhD triggers straight-to-residency." },
        { step: "5", title: "Apply for Post-Study Work Visa → Resident Visa", detail: "3-year open work visa after PhD → Green List Tier 1 (straight-to-permanent-residency) or SMC points application → Resident Visa → NZ citizenship at 5 years with dual nationality." },
      ],
      work: [
        { step: "1", title: "Check Green List first — determine your residency strategy", detail: "Check immigration.govt.nz/green-list. Tier 1 (straight-to-residency): medical practitioners, nurses, civil/mechanical/electrical engineers, STEM teachers, construction project managers. Tier 2 (2 years work first): broader list. This shapes your entire approach." },
        { step: "2", title: "Register with your professional body if required (2–6 months ahead)", detail: "Nurses: NCNZ (Nursing Council of NZ) — requires degree verification + IELTS 7.0 in all bands. Doctors: MCNZ (Medical Council of NZ). Engineers: Engineering NZ (IPENZ). Teachers: Teaching Council of NZ. Start registration early — it takes months." },
        { step: "3", title: "Secure a job offer from an INZ-accredited employer", detail: "Confirm employer is INZ-accredited at immigration.govt.nz. Seek.co.nz, TradeMe Jobs, LinkedIn NZ are the main platforms. Employer submits a Job Check to INZ before your AEWV application." },
        { step: "4", title: "Apply for Accredited Employer Work Visa (AEWV) online (2–4 weeks)", detail: "Apply at visas.immigration.govt.nz. Documents: passport, job offer, qualifications, English proof, medical certificate, police clearance. Fee: NZD 750. Processing: 2–4 weeks. AEWV valid up to 3 years (extendable to 5)." },
        { step: "5", title: "Apply for Resident Visa via Green List or SMC", detail: "Green List Tier 1: apply for Resident Visa immediately upon qualifying job offer. SMC: 180+ points → submit EOI → Resident Visa application. Citizenship after 5 years as resident — dual nationality allowed, keep Nigerian passport." },
      ],
      visitor: [
        { step: "1", title: "Apply fully online at visas.immigration.govt.nz (2–4 weeks before travel)", detail: "Create an INZ account, choose 'Visitor Visa', upload all documents. No embassy or VFS visit needed for most applicants. Fee: NZD 211 (~€115), paid by card." },
        { step: "2", title: "Gather required documents", detail: "Valid passport, passport photo, funds evidence (NZD 1,000/month via bank statements or credit card), return flight itinerary, accommodation proof, proof of Nigerian ties (employment, business, family)." },
        { step: "3", title: "Wait for decision and respond promptly to any requests (2–4 weeks)", detail: "INZ may request additional documents — respond within their deadline. Check your INZ account regularly. No interview required." },
        { step: "4", title: "Travel and declare all biosecurity items on arrival", detail: "Declare all food, plant, and animal products on your arrival card — NZ biosecurity is among the world's strictest. Penalties for non-declaration are heavy and immediate." },
      ],
    },

    tips: {
      undergrad: [
        { title: "Post-Study Work Visa: 3 years of open work rights", body: "New Zealand's Post-Study Work Visa (3 years after Bachelor's/Master's/PhD) is one of the world's most generous. Use it to build SMC points or secure a Green List job — residency becomes achievable within 5–7 years of arriving." },
        { title: "Otago is cheaper than Auckland and just as prestigious", body: "Dunedin (University of Otago) living costs are NZD 12,000–15,000/year vs NZD 20,000+ in Auckland. Otago is world-class in medicine, dentistry, marine science, and pharmacy — and the cheapest major city in NZ." },
        { title: "Medical certificate (chest X-ray) must come from an INZ-approved physician", body: "Nigerian applicants require a chest X-ray for TB screening. It must be done by an INZ-approved panel physician in Lagos or Abuja — find the full list at immigration.govt.nz/medical. Get this early as it takes time." },
        { title: "Auckland is one of the world's most ethnically diverse cities", body: "New Zealand is genuinely multicultural — Nigerians integrate well and there are established African communities in Auckland and Wellington. The country has a reputation for being welcoming to immigrants from across the world." },
      ],
      masters: [
        { title: "Know the Green List before you choose your degree", body: "Identify before you enrol whether your field of study leads to a Green List occupation. Engineering, nursing, medicine, STEM teaching, and construction management all qualify. A Green List Tier 1 job after graduation triggers straight-to-permanent-residency — this changes your entire 5-year plan." },
        { title: "NZ has world-leading expertise in specific fields", body: "New Zealand universities lead globally in marine science, earthquake engineering, dairy/agriculture science, geothermal energy, and environmental science. If your research aligns with NZ's unique natural environment, the opportunities are exceptional." },
        { title: "University of Auckland is top 100 globally", body: "A degree from the University of Auckland carries real international weight — top 100 globally in multiple rankings. It is recognized by employers and immigration systems across the world." },
        { title: "NZ Commonwealth Scholarship is fully funded — apply every year", body: "The NZ Commonwealth Scholarship covers full tuition, NZD 20,000/year living, return flights, and insurance. Apply via the Commonwealth Scholarship Commission Nigeria every September. It is one of the most complete scholarships available to Nigerians." },
      ],
      phd: [
        { title: "NZ Doctoral Scholarship: apply with a strong, specific research proposal", body: "The NZD 27,500/year Doctoral Scholarship is competitive. Shortlisting happens at university level before national selection. A detailed research proposal aligned with your supervisor's work — and evidence of prior research experience — are what make the difference." },
        { title: "NZ's natural environment is a research asset", body: "NZ offers access to unique natural environments for field research: deep-sea marine ecosystems, geothermal zones, earthquake fault lines, pristine agricultural systems. If your research benefits from real-world field access, NZ is a genuine advantage." },
        { title: "Dual nationality: keep your Nigerian passport after NZ citizenship", body: "NZ citizenship does not require renouncing Nigerian citizenship. After 5 years of residency you can hold both — an NZ passport gives visa-free access to 185+ countries while you retain your Nigerian identity and rights." },
      ],
      work: [
        { title: "Green List Tier 1 straight-to-residency is one of the world's best pathways", body: "A nurse, doctor, civil engineer, or STEM teacher with a qualifying NZ job offer can get permanent residency without accumulating SMC points or waiting years. Check the full Tier 1 list carefully at immigration.govt.nz/green-list — it is more extensive than most people realise." },
        { title: "Nigerian nurses can register with NCNZ and get Tier 1 residency", body: "NCNZ (Nursing Council of NZ) registration requires degree verification and IELTS 7.0 overall (7.0 in each band). Once registered and working in a qualifying nursing role, Tier 1 straight-to-residency applies. NZ has a critical nursing shortage." },
        { title: "Wellington and Christchurch offer similar salaries to Auckland at lower cost", body: "Nurses earn NZD 60,000–85,000/year; software engineers NZD 80,000–130,000; civil engineers NZD 75,000–110,000. Auckland is expensive — Wellington and Christchurch offer comparable roles with lower living costs." },
        { title: "NZ income tax is straightforward — no capital gains tax on most assets", body: "Tax rates: 10.5% up to NZD 14,000; 17.5% up to NZD 48,000; 30% up to NZD 70,000; 33% up to NZD 180,000; 39% above. ACC accident compensation levy: ~1.6% additional. No capital gains tax on most investments." },
      ],
      visitor: [
        { title: "Declare everything at biosecurity — fines are immediate and heavy", body: "NZ biosecurity is among the world's strictest. Declare all food, plant material, and animal products on your arrival card. Non-declaration fines start at NZD 400 and can reach NZD 100,000. Never bring meat, fresh fruit, or soil." },
        { title: "Budget NZD 150–200/day for a comfortable visit", body: "New Zealand is expensive for visitors. Self-catering accommodation and campervanning are popular ways to reduce costs outside the main cities. Supermarkets are affordable — eating out in Auckland is expensive." },
        { title: "NZ scenery is unlike anywhere else in the world", body: "Auckland, Wellington, Queenstown, Rotorua, Bay of Islands, and Milford Sound are all remarkable. Mountains, fiords, geothermal fields, beaches, and wine country — all within a two-island country the size of the UK." },
        { title: "Your NZ visa does not cover Australia — plan separately", body: "A NZ visitor visa covers New Zealand only. If your trip includes Australia, apply for a separate Australian ETA (electronic travel authority) — available online for most nationalities including Nigeria." },
      ],
    },

    universities: {
      undergrad: [
        { name: "University of Auckland", location: "Auckland", known_for: "Engineering, medicine, law, business, sciences — NZ's #1 university, top 100 globally", avg_tuition: "NZD 30,000–45,000/yr", acceptance: "Selective", nigerian_community: "Auckland is NZ's most diverse city — active African and Nigerian student community" },
        { name: "University of Otago", location: "Dunedin", known_for: "Medicine, dentistry, marine science, pharmacy — NZ's oldest university, world-class specialist programmes", avg_tuition: "NZD 24,000–37,000/yr", acceptance: "Selective for medicine/dentistry; moderate for others", nigerian_community: "Smaller international community; Dunedin is significantly cheaper than Auckland" },
        { name: "University of Canterbury", location: "Christchurch", known_for: "Engineering, sciences, arts — Christchurch rapidly growing, strong tech and engineering employment", avg_tuition: "NZD 24,000–36,000/yr", acceptance: "Moderate", nigerian_community: "International student community; Christchurch is affordable and welcoming" },
        { name: "Massey University", location: "Palmerston North / Auckland", known_for: "Agriculture, food technology, veterinary science, design — world-leading in agri-food research", avg_tuition: "NZD 22,000–35,000/yr", acceptance: "Moderate", nigerian_community: "International student community; strong for agriculture and food science Nigerians" },
        { name: "AUT (Auckland University of Technology)", location: "Auckland", known_for: "Nursing, business, computing, communication — practice-focused with strong industry connections", avg_tuition: "NZD 26,000–38,000/yr", acceptance: "Moderate", nigerian_community: "Very diverse student body; nursing programme has Nigerian graduates working in NZ health system" },
      ],
      masters: [
        { name: "University of Auckland", location: "Auckland", known_for: "Engineering, computer science, medicine, law, business — top 100 globally; Eiffel-equivalent international scholarships", avg_tuition: "NZD 30,000–45,000/yr", acceptance: "Selective", nigerian_community: "Active Nigerian postgraduate community; Auckland has the largest African diaspora in NZ" },
        { name: "Victoria University of Wellington", location: "Wellington", known_for: "Law, public policy, information management, architecture — capital city location, excellent for policy and government careers", avg_tuition: "NZD 28,000–40,000/yr", acceptance: "Moderate", nigerian_community: "International student body; Wellington is more affordable than Auckland" },
        { name: "University of Otago", location: "Dunedin", known_for: "Marine science, medicine, public health, pharmacy, biomedical science — world-class specialist Master's", avg_tuition: "NZD 24,000–37,000/yr", acceptance: "Selective for specialist programmes", nigerian_community: "International community; Dunedin is NZ's most affordable university city" },
        { name: "Massey University", location: "Palmerston North / Auckland", known_for: "Agriculture, food science, veterinary science, business — NZ Commonwealth Scholarship eligible", avg_tuition: "NZD 22,000–35,000/yr", acceptance: "Moderate", nigerian_community: "International student community; Green List agricultural roles available after graduation" },
        { name: "AUT", location: "Auckland", known_for: "Nursing, business, computer science, communication — Green List nursing pathway for Nigerians", avg_tuition: "NZD 26,000–38,000/yr", acceptance: "Moderate", nigerian_community: "Highly diverse; nursing Master's specifically designed for Green List pathway" },
      ],
      phd: [
        { name: "University of Auckland", location: "Auckland", known_for: "Engineering, biomedical, computer science, marine science — top-ranked research output, NZ Doctoral Scholarship host", avg_tuition: "NZD 6,500–9,000/yr (funded: NZD 27,500/yr scholarship)", acceptance: "Competitive — supervisor match critical", nigerian_community: "Active Nigerian PhD community; Auckland's diversity makes integration easy" },
        { name: "University of Otago", location: "Dunedin", known_for: "Marine biology, public health, biomedical science, pharmacy — unique Southern Ocean research access", avg_tuition: "NZD 6,500–8,500/yr (funded: NZD 27,500/yr scholarship)", acceptance: "Competitive for specialist research", nigerian_community: "International research community; cheaper city than Auckland on PhD stipend" },
        { name: "University of Canterbury", location: "Christchurch", known_for: "Earthquake engineering, materials science, environmental science, geophysics — unique natural laboratory", avg_tuition: "NZD 6,500–8,500/yr (funded: NZD 27,500/yr scholarship)", acceptance: "Competitive", nigerian_community: "International PhD environment; engineering PhDs with Green List pathway" },
        { name: "Massey University", location: "Palmerston North / Auckland", known_for: "Agriculture, food technology, geospatial science, environmental management — world-leading field research", avg_tuition: "NZD 6,500–8,000/yr (funded: NZD 27,500/yr scholarship)", acceptance: "Moderate-competitive", nigerian_community: "International research community; agri-food Green List roles post-PhD" },
      ],
    },
  ...
  US: {
    ...
    overview: `The United States has the world's largest and most internationally recognized university system — MIT, Harvard, Stanford, Yale, Columbia, and hundreds of other world-class institutions. For Nigerians, the US is the highest-stakes, highest-reward destination. Fees can reach $55,000/year at elite private universities — but at the Master's and PhD level in STEM, you typically pay nothing and get paid a stipend to study. Funded STEM PhD places at top-50 US universities are one of the most underused opportunities available to talented Nigerians.

The US immigration path for students runs: F-1 visa → OPT (12 months work authorization after graduation, or 36 months for STEM) → H-1B work visa (employer-sponsored, wage-weighted lottery from FY2027) → Green Card. The H-1B has an annual cap of 85,000 with hundreds of thousands of applicants — but Nigerians on STEM OPT get three lottery attempts. Big tech companies like Google, Microsoft, Amazon, Meta, and Apple routinely sponsor Nigerian engineers all the way to Green Card.

Eight US universities are fully need-blind for international students and meet 100% of demonstrated financial need: Harvard, MIT, Yale, Princeton, Amherst, Dartmouth, Bowdoin, and Brown. Harvard families earning under $100,000/year pay nothing at all — tuition, room, and board covered. Many Nigerians never apply because they assume US education is unaffordable. It is not — if you are applying to the right schools.

The Nigerian-American community is the most educated immigrant group in the US by degree attainment. Over 400,000 Nigerian-born residents are concentrated in Houston, New York, Maryland, New Jersey, Atlanta, and Dallas — a well-networked diaspora spanning medicine, engineering, law, finance, and academia.
...
Visitor visas (B-1/B-2) from Nigeria face scrutiny. Lagos appointment wait times in 2025 are 6–13 months — book the day you decide to travel. The interview is short; the case is made on strong Nigerian ties and honest, clear answers.`,
    ...
    summary: {
      undergrad: {
        intro: "US undergraduate education is the most expensive in the world — but 8 universities are need-blind for international students and meet 100% of financial need. Harvard, MIT, Yale, Princeton, Amherst, Dartmouth, Bowdoin, and Brown all charge nothing to families that cannot afford to pay. The process starts with applying through Common App, filing for financial aid via CSS Profile, and receiving an I-20 from your university before applying for the F-1 visa.",
        firstSteps: [
          { action: "Take TOEFL or IELTS and SAT/ACT if targeting competitive schools", detail: "Many schools are now test-optional for SAT/ACT, but strong scores (1400+ SAT) unlock merit scholarships at mid-tier schools. TOEFL 90+ or IELTS 6.5+ required for most universities. Book at British Council or IDP Nigeria." },
          { action: "Apply through Common App (commonapp.org) to 10–15 universities", detail: "Applications open August 1. Early Decision deadlines: November 1–15. Regular Decision: January 1–15. Apply to safety, match, and reach schools. The personal essay is your most important document — make it specific and genuine." },
          { action: "File CSS Profile for need-based financial aid at need-blind schools", detail: "Go to cssprofile.collegeboard.org — file by November 15 for Early Decision, January 1–15 for Regular Decision. For the 8 need-blind schools, apply regardless of income. Harvard families under $100,000/year pay nothing." },
          { action: "Receive I-20, pay SEVIS fee ($350 at fmjfee.com), and apply for F-1 visa", detail: "After enrolling, your university issues an I-20. Pay SEVIS fee, complete DS-160 at ceac.state.gov/genniv, pay MRV fee ($185), and attend interview at US Embassy Lagos or Consulate Abuja. Apply as early as possible — wait times are long." },
        ],
        keyFacts: [
          "8 universities meet 100% of demonstrated financial need for international students: Harvard, MIT, Yale, Princeton, Amherst, Dartmouth, Bowdoin, Brown",
          "Harvard: families under $100,000/year pay $0; under $200,000/year pay no tuition",
          "Community college → state university transfer costs as little as $60,000 for 4 years total",
          "F-1 students can work on-campus 20 hrs/week; off-campus only via CPT or OPT",
          "STEM OPT after graduation: 36 months of open work authorization — 3 H-1B lottery attempts",
        ],
        outcome: "A US undergraduate degree — especially from a top school with need-blind aid — is a life-changing credential. After graduation, STEM OPT gives 3 years to secure H-1B sponsorship and begin the Green Card process. Nigerian engineers, doctors, and lawyers with US degrees access the world's highest-paying job markets.",
      },
      masters: {
        intro: "The US Master's decision splits into two completely different paths: funded STEM (you pay nothing and receive a stipend) and unfunded (you pay $30,000–60,000/year). Target funded positions in STEM fields exclusively — a funded Master's or PhD at Georgia Tech, Carnegie Mellon, Purdue, or Michigan costs you nothing and pays you to study. The F-1 visa process is identical to undergraduate.",
        firstSteps: [
          { action: "Identify target universities and email professors before applying", detail: "For funded STEM programmes, contact professors whose research aligns with yours. A professor's support is the key to TA/RA funding. Search faculty pages at Carnegie Mellon, Georgia Tech, Michigan, Purdue, UIUC, Ohio State, UMass Amherst, Texas A&M, NC State." },
          { action: "Take GRE (if required) and TOEFL/IELTS", detail: "Many top STEM programmes dropped GRE after COVID — check each school. TOEFL 90–100+ or IELTS 7.0+ typically required. Nigerian IELTS scores from English-medium universities are often accepted without waiver requests." },
          { action: "Apply September–December for January–April funding offers", detail: "Most STEM deadlines: December 1 – January 15. Submit: statement of purpose (most important), CV, 3 recommendation letters, transcripts, TOEFL/IELTS, GRE if required. State your interest in TA/RA funding explicitly in your statement of purpose." },
          { action: "Negotiate funding offers and apply for F-1 visa", detail: "Funded offers include tuition waiver + monthly stipend ($1,500–2,500). You can compare and negotiate across schools. Once you accept: university issues I-20, pay SEVIS fee ($350), DS-160, MRV fee ($185), interview at US Embassy Lagos." },
        ],
        keyFacts: [
          "Funded STEM Master's: full tuition waiver + $18,000–30,000/year stipend + health insurance",
          "Never pay for a US STEM Master's or PhD — funded options exist at every level of university ranking",
          "STEM OPT: 36 months of work authorization after graduation (12 base + 24-month extension)",
          "STEM OPT gives 3 separate H-1B lottery attempts — most Nigerians need 1–2 attempts",
          "Unfunded professional Master's (MBA, law): only justified at top-10 schools with premium salary outcomes",
        ],
        outcome: "Funded STEM Master's → 36-month STEM OPT → H-1B (3 attempts) → Green Card. Nigerian engineers at Google, Amazon, Microsoft, Meta, and Apple followed this exact path. The US STEM Master's → H-1B pipeline is the most reliable route from Nigeria to high-income US employment.",
      },
      phd: {
        intro: "US STEM PhD programmes are almost universally fully funded: tuition waived, stipend paid ($18,000–35,000/year), health insurance included. This is the single most underutilized opportunity for talented Nigerians. A funded PhD at MIT, Stanford, Caltech, UC Berkeley, or any top-50 research university is world-class education — and you are paid to be there. You apply by emailing professors directly, submitting to 10–15 programmes, and targeting professors whose research matches yours.",
        firstSteps: [
          { action: "Email 15–20 professors whose published research matches your interests", detail: "Write brief, specific emails (under 200 words). Reference one paper they published. Explain how your background connects. Ask if they are accepting PhD students. Attach your CV. This is expected and normal — professors post emails because they want applicants. A professor who responds positively is your biggest admission advantage." },
          { action: "Apply to 10–15 funded PhD programmes (December–January deadlines)", detail: "Required: statement of purpose (most critical — be specific about your research vision and the professor you want to work with), CV, 3 reference letters (2 must be academic), transcripts, TOEFL/IELTS, GRE (check — many schools dropped this). Apply broadly." },
          { action: "Evaluate funding offers carefully — compare stipends and cost of living", detail: "Funded offers include I-20 showing university coverage. A $25,000 stipend in West Lafayette, Indiana (Purdue) goes much further than $30,000 in Manhattan. Consider research fit, lab resources, supervisor track record, and placement of recent graduates." },
          { action: "Apply for F-1 visa and plan your Green Card strategy from year one", detail: "Same visa process. After arrival: register with DSO, apply for SSN after 10 days. From year 3 onwards, build EB-1A/EB-2 NIW credentials: publish, present at conferences, accumulate citations and awards." },
        ],
        keyFacts: [
          "US STEM PhD: full tuition waived + $18,000–35,000/year stipend + health insurance — no debt",
          "Top PhD programmes: MIT, Stanford, Caltech, Harvard, Princeton, UC Berkeley, CMU, Michigan, Cornell",
          "After PhD: 36 months STEM OPT — use to self-petition EB-2 NIW or build H-1B + EB-1B",
          "EB-2 NIW (National Interest Waiver): self-petition Green Card after PhD — no employer sponsor needed",
          "Nigerian PhD holders face no per-country Green Card backlog unlike Indian/Chinese nationals",
        ],
        outcome: "US STEM PhD → 36-month STEM OPT → EB-2 NIW self-petition or H-1B → Green Card. PhD holders with strong publication records can self-petition for permanent residency without needing employer sponsorship — the most independent immigration path available.",
      },
      work: {
        intro: "The H-1B is the primary work visa for skilled Nigerians in the US. It requires a specialty occupation, employer sponsorship, and selection in an annual lottery (85,000 cap, wage-weighted from FY2027). Nigerians on STEM OPT participate in the lottery — three attempts if on 3-year STEM OPT. Cap-exempt alternatives exist: O-1A (extraordinary ability, no cap) and positions at universities or non-profits. The Green Card path for Nigerians is relatively clear — no per-country backlog unlike Indian and Chinese nationals.",
        firstSteps: [
          { action: "Use myvisajobs.com to target employers with strong H-1B sponsorship history", detail: "Filter by industry and company. Companies that file thousands of H-1Bs annually — Google, Microsoft, Amazon, Meta, Deloitte, IBM — are experienced sponsors. Prioritize these in your job search over companies with no H-1B history." },
          { action: "Register for H-1B lottery in March through your employer", detail: "Employer registers you online — you do not apply yourself. Registration fee: $215 per beneficiary (employer pays). Results released in April. If selected, USCIS adjudicates petition. Work starts October 1. From FY2027, wage-weighted selection means higher-salary roles have better lottery odds." },
          { action: "If not selected: stay on STEM OPT and try again next year", detail: "Remain on remaining STEM OPT time. Consider cap-exempt employers: universities, hospitals, non-profits — no lottery, immediate H-1B status. Explore O-1A if your credentials support it (publications, awards, press, industry recognition)." },
          { action: "Begin Green Card process through employer (EB-2/EB-3) or self-petition (EB-1A/EB-2 NIW)", detail: "Employer-sponsored: EB-2 PERM or EB-3 PERM — 3–8 years for Nigerians (no country backlog). Self-petition: EB-1A (extraordinary ability) or EB-2 NIW (national interest waiver) — requires strong evidence but no employer needed. Consult an immigration attorney." },
        ],
        keyFacts: [
          "H-1B cap: 65,000 regular + 20,000 US Master's holders = 85,000 total — lottery draw in April",
          "From FY2027: H-1B selection is wage-weighted — higher salary = better lottery odds",
          "H-1B registration fee: $215/beneficiary (employer pays — increased from $10 in 2025)",
          "Nigeria has NO per-country Green Card backlog — unlike India (decades wait) and China",
          "O-1A visa: no cap, no lottery — for Nigerians with exceptional achievements in their field",
        ],
        outcome: "H-1B → EB-2/EB-3 PERM (employer) or EB-2 NIW (self-petition) → Green Card → Citizenship at 5 years. Nigerian engineers, doctors, nurses, and academics have built full lives in the US through this path. The absence of a per-country backlog is Nigeria's biggest immigration advantage in the US.",
      },
      visitor: {
        intro: "The B-1/B-2 US visitor visa is the most carefully scrutinized visa Nigerian applicants face. Approval depends on demonstrating strong ties to Nigeria and a clear, credible reason to visit and return. The interview at US Embassy Lagos or Consulate Abuja is the decisive moment. In 2025, Lagos B-1/B-2 appointment wait times are 6–13 months — book the day you decide to travel.",
        firstSteps: [
          { action: "Complete DS-160 form at ceac.state.gov/genniv before scheduling anything", detail: "Save your application ID. Answer every question honestly and thoroughly. Include accurate travel history, family situation, employment details, and the purpose of your visit. Incomplete or inconsistent DS-160 forms are a red flag." },
          { action: "Pay MRV fee ($185) and book your appointment at ustraveldocs.com immediately", detail: "Pay the $185 MRV fee online first, then schedule your interview. Lagos B-1/B-2 wait times in 2025: 6–13 months. Book the moment you decide to apply. Check travel.state.gov monthly for updated wait times — they change seasonally." },
          { action: "Gather your supporting documents — ties to Nigeria are everything", detail: "Employment letter (on company letterhead, with salary, leave approval, return-to-work date). Bank statements showing stable funds ($3,000–5,000+ for a 2-week trip). Property ownership documents. Family ties (spouse/children remaining in Nigeria). Prior international travel stamps (UK, Schengen, Canada) strengthen your application significantly." },
          { action: "Attend interview with clear, short, confident answers", detail: "Arrive 15 minutes early. The interview is typically under 3 minutes. Answer each question directly. The officer will ask: What do you do in Nigeria? Why are you visiting? Who are you visiting? When will you return? Practice these. Do not volunteer extra information — answer what is asked." },
        ],
        keyFacts: [
          "Lagos B-1/B-2 appointment wait times: 6–13 months in 2025 — book immediately at ustraveldocs.com",
          "MRV fee: $185 — non-refundable regardless of outcome",
          "214(b) refusal means officer felt you did not prove immigrant intent — you can reapply with stronger evidence",
          "Prior UK, Schengen, or Canadian visa stamps significantly strengthen a US visitor visa application",
          "Overstaying: 180+ days = 3-year US bar; 1 year+ = 10-year US bar — and affects visas worldwide",
        ],
        outcome: "A B-1/B-2 visa is typically valid for 10 years with multiple entries, each stay up to 6 months (set by CBP at port of entry). Once granted, it simplifies future US travel enormously. It also strengthens future visa applications to other countries.",
      },
    },
...
**Step 1: Apply to universities through Common App (commonapp.org)**
Apply to 10–15 schools (safety, match, reach). For need-blind schools (Harvard, MIT, Yale, Princeton, Amherst, Dartmouth, Bowdoin, Brown): apply and file for financial aid regardless of income. Harvard families under $100,000/year pay nothing. File CSS Profile at cssprofile.collegeboard.org by November 15 (Early Decision) or January 1–15 (Regular Decision).

**Step 2: Receive admission and I-20**
After enrolling, your university issues an I-20 form — your SEVIS registration document. This is required before your visa interview.

**Step 3: Pay SEVIS fee — $350 at fmjfee.com**
Pay before scheduling your interview. Keep the receipt — bring it to your interview.

**Step 4: Complete DS-160 at ceac.state.gov/genniv**
Fill out carefully and honestly. Save your confirmation barcode.

**Step 5: Pay MRV fee — $185 at ustraveldocs.com**
Then schedule your interview at US Embassy Lagos (2 Walter Carrington Crescent, Victoria Island) or US Consulate Abuja. Apply early — F-1 visa appointments can take several weeks to months.

**Step 6: Attend F-1 visa interview. Bring:**
- Valid passport (6+ months validity beyond programme start)
- DS-160 confirmation barcode page
- SEVIS fee receipt
- I-20 from your university
- Proof of financial support: bank statements, scholarship letter, sponsor letter — covering tuition + living costs
- Academic transcripts, WAEC/NECO results
- TOEFL/IELTS result (if required)
- Evidence of ties to Nigeria: family, future plans, property

**Step 7: Arrive in the US (no earlier than 30 days before programme start on your I-20)**
Report to your university's International Student Office (DSO) within first few days — mandatory for F-1 compliance.

**Work rights:** F-1 students may work on-campus 20 hrs/week during term. Off-campus work requires CPT (Curricular Practical Training) or OPT (Optional Practical Training). After graduation: 12-month OPT, extendable to 36 months for STEM majors.`,

      masters: `**US F-1 Student Visa — Master's**

The visa application process is identical to undergraduate (DS-160, SEVIS $350, MRV $185, interview). The critical difference is funding:

**Funded STEM Master's (target this exclusively):**
Teaching Assistantships (TA) and Research Assistantships (RA) at US universities cover:
- Full tuition waiver
- Monthly stipend ($1,500–2,500/month)
- Health insurance

Universities known for funding Master's students in STEM: Carnegie Mellon, Georgia Tech, University of Michigan, Purdue, Texas A&M, Ohio State, University of Illinois Urbana-Champaign (UIUC), NC State, University of Massachusetts Amherst, Arizona State.

**How to get funding:**
Email professors directly before applying. A professor who agrees to be your Research Advisor can allocate RA funding from their grant. For TA funding, apply directly to the graduate programme and indicate funding interest in your statement of purpose. Applying to PhD programmes and negotiating a funded Master's first is also a valid approach.

**I-20 and financial proof:**
If funded: your I-20 shows university coverage — no personal funds proof needed for covered costs.
If unfunded: you must show personal/family funds of $60,000–100,000+ to cover a 2-year programme.

**STEM OPT — your most valuable post-study right:**
After graduation: 12-month OPT + 24-month STEM extension = 36 months total work authorization. During these 36 months: 3 separate H-1B lottery attempts. Plan your STEM field eligibility from day one. Register with your DSO about OPT 90 days before graduation.`,

      phd: `**US PhD — F-1 Visa + Full Funding**

**Funding — the most important section:**
US STEM PhD programmes are almost universally funded:
- Full tuition waiver (you pay $0)
- Annual stipend: $18,000–35,000 (field and university dependent)
- Health insurance

**How to apply:**
1. Email 15–20 professors whose research matches yours before submitting formal applications. Keep emails under 200 words, specific to their work. Attach your CV. Professors who want to work with you will expedite your admission and funding.
2. Apply to 10–15 funded programmes (December–January deadlines). Required documents: Statement of Purpose (most critical — be specific about research vision and target professor), CV, 3 reference letters (2 academic), transcripts, TOEFL/IELTS, GRE if required.
3. Evaluate funding offers: compare stipend level, cost of living in that city, research fit, supervisor placement record.

**Top funded PhD programmes in STEM:**
MIT, Stanford, Caltech, Harvard, Princeton, UC Berkeley, Carnegie Mellon, University of Michigan, Cornell, Columbia, Johns Hopkins, Purdue, Ohio State, UMass Amherst, Georgia Tech.

**F-1 visa process:** same as above. I-20 shows university covering your costs.

**Green Card from PhD:**
- EB-2 NIW (National Interest Waiver): self-petition — prove your work is in the US national interest. STEM PhD holders with publications qualify. No employer sponsor needed.
- EB-1A (Extraordinary Ability): self-petition — strong for academics with citations, awards, press, invited talks.
- EB-1B (Outstanding Researcher): employer-sponsored — for senior researchers at universities or R&D labs.`,
...
- Employer sponsors and files petition with USCIS
- Annual cap: 65,000 regular + 20,000 US Master's holders = 85,000 total
- Registration period: March each year. Results: April. Work start: October 1
- From FY2027: selection is wage-weighted — higher-salary roles have better lottery odds
- Registration fee: $215/beneficiary (employer pays — increased from $10 in 2025)
- Employer registers you — you do not apply yourself
- After H-1B approval, you may need to attend US Embassy Lagos for visa stamp before travelling

**Key H-1B strategy for Nigerians:**
- Nigerian STEM OPT holders get 3 lottery attempts (3-year STEM OPT window)
- Nigerians have NO per-country Green Card backlog (unlike Indian/Chinese nationals) — once your employer files for Green Card, wait is 3–8 years, not decades
- Big Tech sponsors thousands of H-1Bs annually: Google, Meta, Amazon, Microsoft, Apple all have dedicated immigration teams

**Cap-exempt routes (no lottery):**
- Universities, research institutions, and non-profits: H-1B without cap — immediate status, unlimited spots. A postdoc at a US university gives H-1B immediately.
- O-1A (Extraordinary Ability): no cap, no lottery. For Nigerians with strong citation records, awards, press, industry recognition. Can self-petition with an agent.

**Green Card routes:**
- EB-2 NIW: self-petition — no employer needed. Best for STEM PhD holders with publications.
- EB-1A: Extraordinary ability — self-petition. Best for academics, senior researchers, entrepreneurs.
- EB-1B: Outstanding Researcher — employer-sponsored, for research institution hires.
- EB-2/EB-3 PERM: standard employer-sponsored path — 3–8 years for Nigerians (no country queue).

**Citizenship:** 5 years as Green Card holder. US citizenship does not require renouncing Nigerian citizenship (US does not require it) — many Nigerian-Americans hold both passports in practice.`,

      visitor: `**US B-1/B-2 Visitor Visa**

The B-1/B-2 covers both business visits (B-1) and tourism/personal visits (B-2). Most Nigerians apply for the combined B-1/B-2.

**Step 1: Complete DS-160 at ceac.state.gov/genniv**
Detailed, honest answers about your purpose, employment, travel history, family. Save your confirmation barcode.

**Step 2: Pay MRV fee — $185 at ustraveldocs.com**
Non-refundable. Keep your receipt.

**Step 3: Book interview appointment at ustraveldocs.com**
US Embassy Lagos: 2 Walter Carrington Crescent, Victoria Island.
US Consulate Abuja: Plot 1075, Diplomatic Drive, Central Business District.
Lagos B-1/B-2 wait times in 2025: 6–13 months. Book the day you decide to apply. Check travel.state.gov for current updated wait times.

**Step 4: Gather documents. Consular officers look for:**
- Strong ties to Nigeria: employment letter (letterhead, salary, approved leave, return-to-work date), business registration or bank statements if self-employed, property documents, family staying in Nigeria (spouse, children)
- Clear purpose of visit: why you are going, where you will stay, what you will do
- Ability to fund the trip: bank statements showing $3,000–5,000+ for a typical 2-week trip
- Prior international travel: UK visa, Schengen stamps, Canadian visa all strengthen your case significantly

**Step 5: Interview (typically under 3 minutes)**
Arrive 15 minutes early. Answers should be short, direct, confident. Key questions: what do you do in Nigeria? Why are you visiting? Who are you visiting? When are you returning? Do not volunteer information beyond what is asked.

**If refused (214b):** the officer felt you did not prove non-immigrant intent. You can reapply — but you must present meaningfully new or stronger evidence. The same application will almost certainly be refused again. Address the specific concern.

**Entry:** CBP sets your length of stay at the port of entry — usually 6 months. Do not overstay: 180+ days triggers a 3-year US bar; 1 year+ triggers a 10-year bar. Both affect visa applications globally.`,
    },

    timeline: {
      undergrad: [
        { step: "2–3 years before entry", title: "Build academic and extracurricular record", detail: "US admissions is holistic — strong WAEC/A-Level results, leadership roles, community involvement, and a compelling personal story all matter. Start in SS2/SS3. Take SAT/ACT if targeting merit scholarships. TOEFL or IELTS preparation." },
        { step: "August–January (application year)", title: "Submit Common App to 10–15 universities", detail: "Applications open August 1. Early Decision deadlines: November 1–15. Regular Decision: January 1–15. Apply to safety, match, and reach schools. Write specific, personal essays — avoid generic hardship narratives. File CSS Profile simultaneously for need-based aid at need-blind schools." },
        { step: "March–April", title: "Receive admission and financial aid offers", detail: "Decision Day is May 1. Compare financial aid packages carefully. Contact financial aid offices to negotiate — this is standard and expected. Need-blind schools will explain your exact cost based on family income." },
        { step: "May–June", title: "Enroll, receive I-20, pay SEVIS fee", detail: "Confirm enrollment and pay any deposit. University issues I-20 form. Pay SEVIS fee ($350) at fmjfee.com. Keep all receipts for your visa interview." },
        { step: "June–July", title: "F-1 visa interview at US Embassy Lagos or Consulate Abuja", detail: "Complete DS-160, pay MRV fee ($185), attend interview. Bring: passport, DS-160 barcode, SEVIS receipt, I-20, proof of funds, transcripts, TOEFL/IELTS. Processing: 2–5 days if approved. Apply early — Lagos wait times can stretch." },
        { step: "August", title: "Arrive in the US — no earlier than 30 days before programme start", detail: "Report to International Student Office (DSO) within first few days — mandatory. Apply for SSN after 10 days. Set up US bank account. Attend orientation." },
      ],
      masters: [
        { step: "6–12 months ahead", title: "Take TOEFL/IELTS and GRE (if required), research professors", detail: "TOEFL 90–100+ or IELTS 7.0+ typically needed. GRE: check each school — many STEM programmes dropped it post-COVID. Research faculty at target universities. Email professors whose work aligns with yours before applying." },
        { step: "September–December", title: "Submit applications — target funded STEM programmes", detail: "Most STEM deadlines: December 1 – January 15. Required: statement of purpose (state funding interest explicitly), CV, 3 recommendation letters, transcripts, test scores. Apply to 10+ programmes. Never rely on just one application." },
        { step: "January–April", title: "Receive funding offers and negotiate", detail: "Funded offers include TA/RA offer with tuition waiver + stipend. You can compare packages and negotiate. A funded Master's at a lower-ranked school beats an unfunded one at a higher-ranked school every time." },
        { step: "May–July", title: "I-20 issued, apply for F-1 visa", detail: "SEVIS fee ($350), DS-160, MRV fee ($185), interview at US Embassy Lagos or Consulate Abuja. If funded, I-20 shows university covering costs — no personal funds proof needed for those costs." },
        { step: "Year 1 of studies", title: "Plan OPT and STEM OPT from day one", detail: "Register with your DSO about OPT early. STEM OPT application is filed 90 days before graduation. Your degree must be in a STEM-designated field — check the DHS STEM list. Time your H-1B lottery registration for March of your graduation year." },
        { step: "After graduation", title: "STEM OPT → H-1B lottery (up to 3 attempts)", detail: "Apply for 12-month OPT before graduation, then 24-month STEM OPT extension. Total: 36 months. Register for H-1B each March through your employer. If selected, work starts October 1. If not, remain on OPT and try again next year." },
      ],
      phd: [
        { step: "July–December", title: "Email professors + submit to 10–15 funded programmes", detail: "Email 15–20 professors before applications open. Short, specific emails (under 200 words) referencing their specific published work. Attach your CV. A positive reply dramatically increases your admission and funding chances. Apply broadly — funded PhD admissions are competitive." },
        { step: "January–March", title: "Evaluate funding offers — compare stipends and research fit", detail: "Funded offers include I-20 showing university coverage. Compare: annual stipend (ask about increases over PhD duration), cost of living in that city, supervisor track record, recent graduate placement. Research fit > ranking for PhD success." },
        { step: "May–August", title: "F-1 visa and arrival", detail: "Same visa process. Register with DSO. Apply for SSN after 10 days. Set up US bank account. Attend department orientation and supervisor introductions." },
        { step: "Years 1–3", title: "Build research record and Green Card credentials", detail: "Publish, present at conferences, accumulate citations. From year 3: begin consulting an immigration attorney about EB-2 NIW self-petition. Build evidence: publications, invited talks, peer review credits, press, awards." },
        { step: "Year 4–6", title: "STEM OPT + H-1B lottery or Green Card self-petition", detail: "Apply for STEM OPT on graduation. 36 months of work authorization: 3 H-1B lottery attempts. Simultaneously build EB-2 NIW or EB-1A self-petition case with your attorney. Nigerian PhD holders with publications can often qualify for NIW without employer sponsorship." },
      ],
      work: [
        { step: "Job search", title: "Target H-1B sponsors using myvisajobs.com", detail: "Filter by company and year at myvisajobs.com. Companies filing 1,000+ H-1Bs annually are experienced sponsors: Google, Microsoft, Amazon, Meta, Apple, Deloitte, IBM, Cognizant, Infosys. Use LinkedIn, Levels.fyi for tech salaries, Glassdoor, Indeed. International job boards if applying from outside the US." },
        { step: "March annually", title: "H-1B lottery registration through your employer", detail: "Employer registers you — $215 fee per beneficiary. Results in April. If selected: employer files full petition, USCIS adjudicates, work starts October 1. From FY2027: wage-weighted selection — higher-salary offers have better odds. If not selected: remain on STEM OPT or explore cap-exempt employers." },
        { step: "Ongoing", title: "Cap-exempt and O-1A alternatives if lottery not selected", detail: "Universities, hospitals, research institutions, non-profits: H-1B without cap, no lottery. A postdoc or researcher role at a US university gives immediate H-1B status plus time to build NIW credentials. O-1A for exceptional credentials: publications, awards, industry recognition." },
        { step: "Year 1–2 of H-1B", title: "Begin Green Card process", detail: "Employer-sponsored: EB-2 PERM or EB-3 PERM — employer files PERM labor certification with DOL, then I-140 with USCIS. Nigerians: 3–8 years total (no per-country backlog). Self-petition: EB-2 NIW or EB-1A — consult specialist immigration attorney. Start early." },
        { step: "After 5 years as Green Card holder", title: "Apply for US citizenship (naturalization)", detail: "File N-400. US citizenship does not require renouncing Nigerian citizenship — US law makes no such requirement. Many Nigerian-Americans hold both passports. Citizenship brings: US passport (visa-free to 186 countries), voting rights, full social security eligibility." },
      ],
      visitor: [
        { step: "Complete immediately", title: "DS-160 form at ceac.state.gov/genniv", detail: "Detailed, honest answers. Travel history, employment, family situation, purpose of visit. Save your application ID and confirmation barcode — you need this at the interview." },
        { step: "Book immediately — 6–13 months ahead", title: "Pay $185 MRV fee and book interview at ustraveldocs.com", detail: "Lagos B-1/B-2 wait times in 2025: 6–13 months. Book the moment you decide to apply. Check travel.state.gov monthly for updated wait times — they shift seasonally. Abuja Consulate typically has shorter wait times than Lagos." },
        { step: "2–4 weeks before interview", title: "Gather all supporting documents", detail: "Employment letter (letterhead, salary, leave approval, return-to-work date). 6 months bank statements showing stable income. Property documents. Family staying in Nigeria. Purpose of visit documentation. Prior international visa stamps (UK, Schengen, Canada) — include these passports." },
        { step: "Interview day", title: "Attend interview with short, confident, specific answers", detail: "Arrive 15 minutes early. Interview is typically 2–3 minutes. Prepare answers: why visiting, what you do in Nigeria, who is staying in Nigeria, when you return. Be direct. If refused: request to know the specific section cited (usually 214b), then address it in a new application." },
      ],
    },

    tips: {
      undergrad: [
        { title: "8 US universities are need-blind for international students — apply to all of them", body: "Harvard, MIT, Yale, Princeton, Amherst, Dartmouth, Bowdoin, and Brown all meet 100% of demonstrated financial need for international students. Harvard families earning under $100,000/year pay nothing — tuition, room, and board covered. Under $200,000/year: no tuition. Apply regardless of income. File CSS Profile. The worst outcome is a rejection — not applying is worse." },
        { title: "Community college → state university transfer is the most affordable path", body: "Two years at a US community college costs $6,000–10,000/year. Then transfer to a state university (UC system, University of Texas, University of Michigan) as a junior. Total 4-year cost can be under $60,000. Community college credits transfer cleanly to top public universities — this is a legitimate, respected route." },
        { title: "The personal essay is your biggest differentiator at competitive schools", body: "US admissions is holistic — your essay matters as much as your grades at elite schools. Write about something specific, genuine, and personal to you. Nigerian students sometimes default to generic hardship narratives. The best essays are surprising, specific, and reveal a real person. Start early, rewrite many times, get feedback." },
        { title: "Merit scholarships at mid-tier schools can make them more affordable than 'cheaper' options", body: "Schools like University of Alabama, University of Tulsa, Northeastern, and University of Denver offer large merit scholarships to international students with strong grades and test scores. A 1400+ SAT or 30+ ACT can unlock $15,000–25,000/year in merit aid — making a US degree cost less than some European alternatives." },
      ],
      masters: [
        { title: "Never pay for a STEM Master's or PhD in the US — funded options always exist", body: "If a US university offers you a STEM Master's or PhD without a tuition waiver and stipend, reject it and apply elsewhere. Paying $50,000/year for a STEM graduate degree is unnecessary — Carnegie Mellon, Georgia Tech, Purdue, Michigan, and hundreds of other top universities fund STEM graduate students routinely. Apply broadly across 10–15 programmes." },
        { title: "Email professors before applying — it is the most underused tool for Nigerian applicants", body: "In US PhD and research Master's admissions, professors have enormous influence over who gets admitted and funded. Emailing a professor before you apply — referencing their specific work, explaining your research interests, attaching your CV — is expected and effective. A professor who wants to work with you will advocate for your admission and RA funding." },
        { title: "STEM OPT's 36 months is the most valuable post-study benefit in any country", body: "36 months of open US work authorization after a STEM degree — no employer restriction, three separate H-1B lottery attempts. Most Nigerian engineers need 1–2 lottery attempts to get H-1B. Plan your STEM field eligibility from day one: ensure your degree is on the DHS STEM Designated Degree Programme list. Your DSO (International Student Office) can advise." },
        { title: "Cost of living varies enormously — a stipend goes much further outside big cities", body: "A funded PhD or Master's stipend of $22,000/year in West Lafayette, Indiana (Purdue) or College Station, Texas (Texas A&M) means genuine savings. The same stipend in San Francisco or NYC barely covers rent. Factor cost of living into your offer comparisons. Levels.fyi shows real salary and cost-of-living data by city." },
      ],
      phd: [
        { title: "EB-2 NIW is the Nigerian STEM PhD graduate's most powerful Green Card path", body: "The National Interest Waiver lets you self-petition for permanent residency without an employer — you prove your work benefits the US national interest. STEM PhD graduates with publications, conference presentations, and citations are well-positioned to qualify. Start building this record from year one. Consult an immigration attorney from year 3 of your PhD." },
        { title: "Emailing professors is not just acceptable — it is how funded PhD positions are filled", body: "US PhD professors actively look for strong students. Your email to a professor is not an intrusion — it is how the system works. Write to 15–20 professors, keep emails specific and under 200 words, reference one paper they published, attach your CV, ask if they are taking students. One positive reply can change your application outcome entirely." },
        { title: "Nigerians have a massive advantage over Indian and Chinese nationals in Green Card processing", body: "The US Green Card system has per-country quotas — Indian and Chinese nationals face decade-long backlogs for EB-2 and EB-3. Nigeria has no such backlog. Once your employer files your Green Card petition, wait times are 3–8 years — not 50+ years. This is one of the most strategically important immigration facts for Nigerians considering the US." },
        { title: "Build your EB-1A/NIW record from year one — publications, citations, talks, awards", body: "The EB-1A (extraordinary ability) and EB-2 NIW Green Cards are based on evidence of achievement: publications in reputable journals, citation counts, invited conference presentations, peer review work, press coverage, awards. These take years to accumulate. Starting intentionally in year 1 of your PhD — choosing journals with strong indexing, attending top conferences — puts you in a much stronger position by year 4–5." },
      ],
      work: [
        { title: "Use myvisajobs.com to identify H-1B sponsors before applying for jobs", body: "myvisajobs.com tracks every H-1B petition filed with USCIS by company and year. Companies filing 5,000+ H-1Bs annually are well-resourced sponsors: Google, Amazon, Microsoft, Meta, Apple, Deloitte, IBM, Infosys, Cognizant. These companies have internal immigration teams and established processes. Prioritize them over smaller companies with no H-1B history — the sponsorship process is smoother and more reliable." },
        { title: "Nigeria's lack of Green Card backlog is a career-defining advantage — use it strategically", body: "Indian-born H-1B holders can wait 70+ years for a Green Card (EB-2 backlog). Nigerian-born holders typically wait 3–8 years. This means: target companies and roles where your employer will file for your Green Card quickly. Negotiate GC sponsorship into your offer. A faster Green Card means faster career freedom — you can change employers, start a company, or self-petition once you have it." },
        { title: "Cap-exempt H-1B at universities and non-profits is available immediately — no lottery", body: "Any US university, research institution, or qualifying non-profit can hire you on H-1B without the annual cap or lottery. A postdoc or research scientist role at a US university gives you immediate H-1B status and lets you build the publication record needed for EB-2 NIW or EB-1B Green Card. Many Nigerian academics have used this path to bypass the H-1B lottery entirely." },
        { title: "Texas and Florida have no state income tax — significantly higher take-home pay than California", body: "US federal income tax applies everywhere. But state income tax varies from 0% (Texas, Florida, Nevada, Washington) to 13.3% (California). A Nigerian software engineer earning $150,000 at Google Austin takes home roughly $15,000–18,000 more per year than a counterpart at Google Mountain View in California — before accounting for lower cost of living in Texas. Major tech employers in Texas: Google, Amazon, Apple, Oracle, Dell." },
      ],
      visitor: [
        { title: "Book your B-1/B-2 appointment the day you decide to travel — not when you are ready", body: "Lagos B-1/B-2 US visa appointment wait times in 2025 are 6–13 months — among the longest for any US post worldwide. You should book your interview appointment before you even start gathering documents. You can gather documents over the following months. Waiting until you feel 'ready' can cost you a year. Check travel.state.gov monthly for current Lagos wait times." },
        { title: "Your employment letter is the single most important document in your application", body: "The consular officer needs to believe you will return to Nigeria after your visit. An employment letter on company letterhead, signed by HR, confirming your role, your salary, your approved leave dates, and your return-to-work date is the clearest proof of ties. If self-employed: business registration certificate, 6 months bank statements showing business income, and a letter from your accountant." },
        { title: "Prior international travel is the strongest signal you return home as required", body: "UK visa stamps, Schengen visa stamps, and Canadian visa stamps in your passport prove you have traveled internationally before and returned to Nigeria as required. If you have any of these, bring those passports to your interview — even expired ones. Multiple international travel stamps dramatically improve approval odds." },
        { title: "A 214(b) refusal is not permanent — but the same application will fail again", body: "Section 214(b) refusal means the officer was not convinced you have strong enough ties to Nigeria to return. You can reapply — but you must present meaningfully stronger or new evidence. The same bank statements, the same employment letter, the same application will almost certainly be refused again. Wait 6–12 months, build stronger evidence (property purchase, marriage certificate, business growth), and reapply with a clearly different financial or personal situation." },
      ],
    },

    universities: {
      undergrad: [
        { name: "Massachusetts Institute of Technology (MIT)", location: "Cambridge, MA", known_for: "Engineering, Computer Science, Physics, Economics — world #1 in multiple fields", avg_tuition: "$57,986/yr (need-blind — meets 100% of need)", acceptance: "~4%", nigerian_community: "Growing" },
        { name: "Harvard University", location: "Cambridge, MA", known_for: "Law, Medicine, Business (HBS), Government (Kennedy School), Sciences — need-blind for all nationalities", avg_tuition: "$59,076/yr (families under $100k pay $0)", acceptance: "~3.5%", nigerian_community: "Growing" },
        { name: "Stanford University", location: "Stanford, CA", known_for: "Engineering, CS, Business (GSB), Medicine, Law — Silicon Valley access, top-3 globally", avg_tuition: "$62,484/yr (meets full demonstrated need)", acceptance: "~4%", nigerian_community: "Growing" },
        { name: "Georgia Institute of Technology", location: "Atlanta, GA", known_for: "Engineering, CS, Aerospace, Biomedical, Industrial Engineering — top 10 engineering, affordable public school", avg_tuition: "$33,794/yr (out-of-state)", acceptance: "~17%", nigerian_community: "Large" },
        { name: "University of Texas at Austin", location: "Austin, TX", known_for: "Petroleum Engineering, CS, Business, Law, Architecture — largest Nigerian student population in the US", avg_tuition: "$38,228/yr (out-of-state)", acceptance: "~31%", nigerian_community: "Very large" },
        { name: "University of Michigan", location: "Ann Arbor, MI", known_for: "Engineering, Medicine, Law, Business (Ross School) — strong Nigerian alumni network", avg_tuition: "$53,232/yr (out-of-state)", acceptance: "~18%", nigerian_community: "Large" },
      ],
      masters: [
        { name: "Carnegie Mellon University (CMU)", location: "Pittsburgh, PA", known_for: "Computer Science, AI, Robotics, Data Science, Design — world #1 CS, strong TA/RA funding", avg_tuition: "$58,924/yr (funded STEM positions available)", acceptance: "~15%", nigerian_community: "Growing" },
        { name: "Georgia Tech", location: "Atlanta, GA", known_for: "STEM Master's with TA/RA funding, STEM OPT placement — affordable top engineering school", avg_tuition: "$33,794/yr (out-of-state)", acceptance: "~21%", nigerian_community: "Large" },
        { name: "Purdue University", location: "West Lafayette, IN", known_for: "Engineering, CS, Pharmacy, Agriculture — excellent RA funding, very affordable cost of living", avg_tuition: "$29,128/yr (out-of-state)", acceptance: "~67%", nigerian_community: "Growing" },
        { name: "University of Illinois Urbana-Champaign (UIUC)", location: "Champaign, IL", known_for: "CS, Electrical Engineering, Accountancy, MCS programme — top-5 CS, strong industry connections", avg_tuition: "$32,674/yr (out-of-state)", acceptance: "~45%", nigerian_community: "Growing" },
        { name: "Columbia University", location: "New York City, NY", known_for: "Engineering, Journalism, Law, Business — NYC location means unmatched internship and career access", avg_tuition: "$63,530/yr", acceptance: "~12%", nigerian_community: "Large" },
        { name: "University of Southern California (USC)", location: "Los Angeles, CA", known_for: "Engineering, CS, Film, Business — large international community, strong industry connections in LA", avg_tuition: "$64,726/yr", acceptance: "~12%", nigerian_community: "Growing" },
      ],
      phd: [
        { name: "MIT", location: "Cambridge, MA", known_for: "STEM PhD fully funded — world-class in every engineering and science discipline", avg_tuition: "Fully funded + $40,000+/yr stipend (varies by dept)", acceptance: "~4%", nigerian_community: "Growing" },
        { name: "Stanford University", location: "Stanford, CA", known_for: "Fully funded STEM PhD, Silicon Valley access, top-3 CS/EE/ME globally", avg_tuition: "Fully funded + $35,000–45,000/yr stipend", acceptance: "~4%", nigerian_community: "Growing" },
        { name: "UC Berkeley", location: "Berkeley, CA", known_for: "Engineering, CS, Public Policy, Law, Chemistry — funded PhD, top public research university globally", avg_tuition: "Fully funded + $28,000–38,000/yr stipend", acceptance: "~11%", nigerian_community: "Growing" },
        { name: "Johns Hopkins University", location: "Baltimore, MD", known_for: "Medicine, Public Health, Biomedical Engineering, International Studies — fully funded PhD in STEM and humanities", avg_tuition: "Fully funded + $28,000–36,000/yr stipend", acceptance: "~8%", nigerian_community: "Growing" },
        { name: "University of Michigan", location: "Ann Arbor, MI", known_for: "Engineering, Medicine, Public Health — strong Nigerian PhD alumni network, fully funded positions", avg_tuition: "Fully funded + $25,000–35,000/yr stipend", acceptance: "~18%", nigerian_community: "Large" },
        { name: "Purdue University", location: "West Lafayette, IN", known_for: "Engineering, CS, Agriculture — funded PhD, very low cost of living, stipend goes far", avg_tuition: "Fully funded + $20,000–28,000/yr stipend", acceptance: "~67%", nigerian_community: "Growing" },
      ],
    },

    scholarships: {
      undergrad: [
        { name: "Need-Blind Financial Aid — 8 Universities", amount: "Harvard: $0 for families under $100,000/year (tuition + room + board). All 8 universities meet 100% of demonstrated financial need — no loans, no work requirements for the covered amount", university: "Harvard, MIT, Yale, Princeton, Amherst, Dartmouth, Bowdoin, Brown — all need-blind for international students", deadline: "CSS Profile: November 15 (Early Decision) / January 1–15 (Regular Decision) at cssprofile.collegeboard.org", url: "https://college.harvard.edu/financial-aid" },
        { name: "Mastercard Foundation Scholars Program", amount: "Full scholarship — tuition, room, board, travel, stipend — for African students with financial need and leadership potential", university: "Partner universities vary by year — check mastercardfdn.org for current US partner list", deadline: "Varies by partner university — check mastercardfdn.org each academic year", url: "https://mastercardfdn.org/all/scholars/" },
      ],
      masters: [
        { name: "Teaching/Research Assistantship (TA/RA)", amount: "Full tuition waiver + $18,000–30,000/year stipend + health insurance — the primary funding route for STEM Master's in the US", university: "All US research universities with graduate programmes: CMU, Georgia Tech, Michigan, Purdue, UIUC, Ohio State, Texas A&M, UMass Amherst, NC State and more", deadline: "Apply with your programme application (September–January deadlines). State funding interest explicitly in your statement of purpose.", url: "https://www.gradcafe.com/" },
        { name: "Fulbright Foreign Student Program (Nigeria)", amount: "Full funding — tuition, living allowance, health insurance, travel — competitive, prestigious", university: "US universities across all disciplines — US Embassy Lagos administers Nigerian nominations", deadline: "Apply through US Embassy Lagos — typically opens February, closes May/June each year", url: "https://ng.usembassy.gov/education-culture/educational-exchange/fulbright-program/" },
      ],
      phd: [
        { name: "University PhD Fellowship / TA-RA Funding (standard funded PhD)", amount: "Full tuition waiver + $18,000–40,000/year stipend + health insurance — standard offer for admitted STEM PhD students at US research universities", university: "All US research universities in STEM fields — MIT, Stanford, CMU, Michigan, Purdue, Georgia Tech, Cornell, Columbia, Johns Hopkins and all top-50 programmes", deadline: "December 1 – January 15 for most STEM PhD programmes. Apply to 10–15 programmes.", url: "https://www.uscis.gov/" },
        { name: "Fulbright Foreign Student Program (PhD track)", amount: "Full funding for PhD study or research at US universities — prestigious government scholarship", university: "US universities — Embassy Lagos manages Nigerian nominations and selection", deadline: "Apply via US Embassy Lagos — typically February–May annually", url: "https://ng.usembassy.gov/education-culture/educational-exchange/fulbright-program/" },
      ],
      work: [],
    },
    ...
    embassy: {
      ...
      phone: "Visa enquiries: ustraveldocs.com (online only). Emergency line: +234 1 460 3400 (Lagos)",
      note: "All US visa appointments (F-1, B-1/B-2, H-1B stamp) for Nigerian applicants are booked through ustraveldocs.com. Pay the MRV fee ($185) online first, then schedule your interview. Lagos B-1/B-2 appointment wait times in 2025: 6–13 months — book immediately after deciding to apply. F-1 student visa appointments are typically shorter waits. F-1 students may schedule interviews up to 120 days before their programme start date on the I-20. SEVIS fee ($350) for F-1 is paid separately at fmjfee.com and must be paid before your interview. DS-160 form: ceac.state.gov/genniv. Check travel.state.gov for real-time Lagos appointment wait times (updated monthly). H-1B and Green Card petitions are filed by your employer with USCIS inside the US — not at the embassy.",
      website: "https://ng.usembassy.gov/",
      visa_apply: "https://www.ustraveldocs.com/ng/",
      official_immigration: "https://www.uscis.gov/",
      extra_links: [
        { label: "US TravelDocs Nigeria — visa appointment booking", url: "https://www.ustraveldocs.com/ng/" },
        { label: "DS-160 Nonimmigrant Visa Application form", url: "https://ceac.state.gov/genniv/" },
        { label: "SEVIS I-901 Fee payment (F-1 students — $350)", url: "https://www.fmjfee.com/" },
        { label: "State Dept: current visa wait times by post", url: "https://travel.state.gov/content/travel/en/us-visas/visa-information-resources/wait-times.html" },
        { label: "Common App — US undergraduate admissions portal", url: "https://www.commonapp.org/" },
        { label: "CSS Profile — need-based financial aid application", url: "https://cssprofile.collegeboard.org/" },
        ...
        { label: "USCIS — H-1B, Green Card, citizenship", url: "https://www.uscis.gov/" },
        { label: "STEM OPT Hub — Study in the States (DHS)", url: "https://studyinthestates.dhs.gov/stem-opt-hub" },
